...
var tm = function (t) {
    ...
    const r = `{{lit-${String(Math.random()).slice(2)}}}`, o = `\x3c!--${r}--\x3e`, i = new RegExp(`${r}|${o}`), s = "$lit$";

    class a {
        constructor(t, e) {
            this.parts = [], this.element = e;
            const n = [], o = [], a = document.createTreeWalker(e.content, 133, null, !1);
            let l = 0, p = -1, d = 0;
            const {strings: f, values: {length: y}} = t;
            for (; d < y;) {
                const t = a.nextNode();
                if (null !== t) {
                    if (p++, 1 === t.nodeType) {
                        if (t.hasAttributes()) {
                            ...
                            for (; r-- > 0;) {
                                const e = f[d], n = h.exec(e)[2], r = n.toLowerCase() + s, o = t.getAttribute(r);
                                t.removeAttribute(r);
                                const a = o.split(i);
                                this.parts.push({type: "attribute", index: p, name: n, strings: a}), d += a.length - 1
                            }
                        }
                        ...
                        const e = t.data;
                        if (e.indexOf(r) >= 0) {
                            const r = t.parentNode, o = e.split(i), a = o.length - 1;
                            for (let e = 0; e < a; e++) {
                                let n, i = o[e];
                                if ("" === i) n = u(); else {
                                    const t = h.exec(i);
                                    null !== t && c(t[2], s) && (i = i.slice(0, t.index) + t[1] + t[2].slice(0, -s.length) + t[3]), n = document.createTextNode(i)
                                }
                                r.insertBefore(n, t), this.parts.push({type: "node", index: ++p})
                            }
                            "" === o[a] ? (r.insertBefore(u(), t), n.push(t)) : t.data = o[a], d += a
                        }
                    } else if (8 === t.nodeType) if (t.data === r) {
                        const e = t.parentNode;
                        null !== t.previousSibling && p !== l || (p++, e.insertBefore(u(), t)), l = p, this.parts.push({type: "node", index: p}), null === t.nextSibling ? t.data = "" : (n.push(t), p--), d++
                    } else {
                        let e = -1;
                        for (; -1 !== (e = t.data.indexOf(r, e + 1));) this.parts.push({type: "node", index: -1}), d++
                    }
    ...
    }, l = t => -1 !== t.index, u = () => document.createComment(""), h = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/
}, function (t, e, n) {
    "use strict";
    n.d(e, "i", (function () {
        return l
    ...
    var r = n(11), o = n(5), i = n(4), s = n(15), a = n(13), c = n(0);
    const l = t => null === t || !("object" == typeof t || "function" == typeof t), u = t => Array.isArray(t) || !(!t || !t[Symbol.iterator]);
    ...
    class h {
        ...
        _getValue() {
            ...
            for (let r = 0; r < e; r++) {
                ...
                if (void 0 !== e) {
                    const t = e.value;
                    if (l(t) || !u(t)) n += "string" == typeof t ? t : String(t); else for (const e of t) n += "string" == typeof e ? e : String(e)
                }
            }
            return n += t[e], n
        }
    ...
    class p {
        ...
        setValue(t) {
            t === i.a || l(t) && t === this.value || (this.value = t, Object(r.b)(t) || (this.committer.dirty = !0))
        }
    ...
    class d {
        ...
        appendInto(t) {
            this.startNode = t.appendChild(Object(c.c)()), this.endNode = t.appendChild(Object(c.c)())
        }
        ...
        appendIntoPart(t) {
            t.__insert(this.startNode = Object(c.c)()), t.__insert(this.endNode = Object(c.c)())
        }

        insertAfterPart(t) {
            t.__insert(this.startNode = Object(c.c)()), this.endNode = t.endNode, t.endNode = this.startNode
        }
        ...
        commit() {
            ...
            const t = this.__pendingValue;
            t !== i.a && (l(t) ? t !== this.value && this.__commitText(t) : t instanceof a.b ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : u(t) ? this.__commitIterable(t) : t === i.b ? (this.value = i.b, this.clear()) : this.__commitText(t))
        }
        ...
        __commitTemplateResult(t) {
            ...
            if (this.value instanceof s.a && this.value.template === e) this.value.update(t.values); else {
                const n = new s.a(e, t.processor, this.options), r = n._clone();
        ...
        __commitIterable(t) {
            ...
            const e = this.value;
            let n, r = 0;
            for (const o of t) n = e[r], void 0 === n && (n = new d(this.options), e.push(n), 0 === r ? n.appendIntoPart(this) : n.insertAfterPart(e[r - 1])), n.setValue(o), n.commit(), r++;
    ...
    class f {
        ...
        commit() {
            ...
            const t = !!this.__pendingValue;
            this.value !== t && (t ? this.element.setAttribute(this.name, "") : this.element.removeAttribute(this.name), this.value = t), this.__pendingValue = i.a
        }
    }
    ...
    class v {
        ...
        commit() {
            ...
            if (this.__pendingValue === i.a) return;
            const t = this.__pendingValue, e = this.value, n = null == t || null != e && (t.capture !== e.capture || t.once !== e.once || t.passive !== e.passive), o = null != t && (null == e || n);
            n && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options), o && (this.__options = b(t), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)), this.value = t, this.__pendingValue = i.a
        }
    ...
    const b = t => t && (g ? {capture: t.capture, passive: t.passive, once: t.once} : t.capture)
}, function (t, e, n) {
    "use strict";
    ...
    function s(t, e, n) {
        if (void 0 === e && (e = []), void 0 === n && (n = !1), null == e && (e = []), Array.isArray(t) || h(t) && !n) for (var r = 0; r < t.length; ++r) s(t[r], e, n); else e.push(t);
        return e
    }
    ...
    function l(t, e) {
        var n = e.length;
        return i((t = null == t ? e.map((function (t, e) {
            return e
    ...
    e.shuffle = o, e.clamp = function (t, e, n) {
        ...
        return n
    }, e.assert = i, e.assertShapesMatch = function (t, e, n) {
        void 0 === n && (n = ""), i(a(t, e), (function () {
    ...
    }, e.flatten = s, e.sizeFromShape = function (t) {
        if (0 === t.length) return 1;
        for (var e = t[0], n = 1; n < t.length; n++) e *= t[n];
        return e
    }, e.isScalarShape = function (t) {
        return 0 === t.length
    }, e.arraysEqual = a, e.isInt = c, e.tanh = function (t) {
        ...
        var i = t.slice();
        return i[r] = e / n, i
    }, e.parseAxisParam = l, e.squeezeShape = function (t, e) {
        for (var n = [], r = [], o = null != e && Array.isArray(e) && 0 === e.length, i = null == e || o ? null : l(e, t).sort(), s = 0, a = 0; a < t.length; ++a) {
            if (null != i) {
                if (i[s] === a && 1 !== t[a]) throw new Error("Can't squeeze axis " + a + " since its dim '" + t[a] + "' is not 1");
                (null == i[s] || i[s] > a) && 1 === t[a] && (n.push(t[a]), r.push(a)), i[s] <= a && s++
            }
        ...
        return n
    }, e.checkConversionForErrors = u, e.isValidDtype = function (t) {
    ...
    }, e.isString = p, e.isBoolean = d, e.isNumber = f, e.inferDtype = function t(e) {
        return Array.isArray(e) ? t(e[0]) : e instanceof Float32Array ? "float32" : e instanceof Int32Array || e instanceof Uint8Array ? "int32" : f(e) ? "float32" : p(e) ? "string" : d(e) ? "bool" : "float32"
        ...
        if (Array.isArray(t) && (t = s(t)), n && u(t, e), function (t, e) {
        ...
        return function t(e, n, r) {
            var o = new Array;
            if (1 === n.length) for (var i = n[0], s = 0; s < i; s++) o[s] = r[e + s]; else {
                i = n[0];
                var a = n.slice(1), c = a.reduce((function (t, e) {
                    return t * e
                }));
        ...
        return n
    }, e.makeZerosTypedArray = y, e.now = function () {
        ...
        return void 0 === e && (e = "utf-8"), e = e || "utf-8", r.env().platform.encode(t, e)
    }, e.decodeString = function (t, e) {
        return void 0 === e && (e = "utf-8"), e = e || "utf-8", r.env().platform.decode(t, e)
    }
}, function (t, e, n) {
    "use strict";
    n.r(e);
    var r = n(6), o = n(5), i = n(0);

    function s(t, e) {
        const {element: {content: n}, parts: r} = t, o = document.createTreeWalker(n, 133, null, !1);
        let i = c(r), s = r[i], a = -1, l = 0;
        const u = [];
        let h = null;
        for (; o.nextNode();) {
            a++;
            const t = o.currentNode;
            for (t.previousSibling === h && (h = null), e.has(t) && (u.push(t), null === h && (h = t)), null !== h && l++; void 0 !== s && s.index === a;) s.index = null !== h ? -1 : s.index - l, i = c(r, i), s = r[i]
        }
    ...
    const f = t => e => {
        const n = p(e.type, t);
        let r = u.a.get(n);
        void 0 === r && (r = {stringsArray: new WeakMap, keyString: new Map}, u.a.set(n, r));
        ...
        if (o = r.keyString.get(s), void 0 === o) {
            ...
            d && window.ShadyCSS.prepareTemplateDom(n, t), o = new i.a(e, n), r.keyString.set(s, o)
        }
        return r.stringsArray.set(e.strings, o), o
    }, y = ["html", "svg"], m = new Set, g = (t, e, n) => {
        m.add(t);
        const r = n ? n.element : document.createElement("template"), o = e.querySelectorAll("style"), {length: i} = o;
        ...
        n ? function (t, e, n = null) {
            const {element: {content: r}, parts: o} = t;
            if (null == n) return void r.appendChild(e);
            const i = document.createTreeWalker(r, 133, null, !1);
            let s = c(o), l = 0, u = -1;
            for (; i.nextNode();) {
                for (u++, i.currentNode === n && (l = a(e), n.parentNode.insertBefore(e, n)); -1 !== s && o[s].index === u;) {
                    if (l > 0) {
        ...
        }(n, l, h.firstChild) : h.insertBefore(l, h.firstChild), window.ShadyCSS.prepareTemplateStyles(r, t);
        const d = h.querySelector("style");
        if (window.ShadyCSS.nativeShadow && null !== d) e.insertBefore(d.cloneNode(!0), e.firstChild); else if (n) {
    ...
    }, b = (t, e) => e !== t && (e == e || t == t), w = {attribute: !0, type: String, converter: v, reflect: !1, hasChanged: b}, _ = Promise.resolve(!0);

    class x extends HTMLElement {
        constructor() {
            super(), this._updateState = 0, this._instanceProperties = void 0, this._updatePromise = _, this._hasConnectedResolver = void 0, this._changedProperties = new Map, this._reflectingProperties = void 0, this.initialize()
        }
        ...
        static finalize() {
            ...
            if (t.hasOwnProperty("finalized") || t.finalize(), this.finalized = !0, this._ensureClassProperties(), this._attributeToPropertyMap = new Map, this.hasOwnProperty(JSCompiler_renameProperty("properties", this))) {
                const t = this.properties, e = [...Object.getOwnPropertyNames(t), ..."function" == typeof Object.getOwnPropertySymbols ? Object.getOwnPropertySymbols(t) : []];
        ...
        static _propertyValueFromAttribute(t, e) {
            const n = e.type, r = e.converter || v, o = "function" == typeof r ? r : r.fromAttribute;
            return o ? o(t, n) : t
        }
        ...
        _propertyToAttribute(t, e, n = w) {
            const r = this.constructor, o = r._attributeNameForProperty(t, n);
            if (void 0 !== o) {
                const t = r._propertyValueToAttribute(e, n);
                if (void 0 === t) return;
                this._updateState = 8 | this._updateState, null == t ? this.removeAttribute(o) : this.setAttribute(o, t), this._updateState = -9 & this._updateState
            }
        }
        ...
        _requestUpdate(t, e) {
            let n = !0;
            if (void 0 !== t) {
                const r = this.constructor, o = r._classProperties.get(t) || w;
                r._valueHasChanged(this[t], e, o.hasChanged) ? (this._changedProperties.has(t) || this._changedProperties.set(t, e), !0 !== o.reflect || 16 & this._updateState || (void 0 === this._reflectingProperties && (this._reflectingProperties = new Map), this._reflectingProperties.set(t, o))) : n = !1
            }
    ...
    })(t, e), E = (t, e) => "method" !== e.kind || !e.descriptor || "value" in e.descriptor ? {
    ...
    }, P = (t, e) => ({kind: "method", placement: "prototype", key: e.key, descriptor: t}), C = t => (e, n) => void 0 !== n ? ((t, e, n) => {
        Object.assign(e[n], t)
    })(t, e, n) : ((t, e) => Object.assign({}, e, {
        finisher(n) {
            Object.assign(n.prototype[e.key], t)
        }
    }))(t, e), R = "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, D = Symbol();

    class O {
        constructor(t, e) {
            if (e !== D) throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
            this.cssText = t
        }
    ...
    const M = t => new O(String(t), D), L = (t, ...e) => {
    ...
    const j = t => t.flat ? t.flat(1 / 0) : function t(e, n = []) {
    ...
    class N extends x {
        ...
        static _getUniqueStyles() {
            ...
            if (Array.isArray(t)) {
                j(t).reduceRight((t, e) => (t.add(e), t), new Set).forEach(t => e.unshift(t))
            } else t && e.push(t);
            return e
        }
        ...
        adoptStyles() {
            ...
            0 !== t.length && (void 0 === window.ShadyCSS || window.ShadyCSS.nativeShadow ? R ? this.renderRoot.adoptedStyleSheets = t.map(t => t.styleSheet) : this._needsShimAdoptedStyleSheets = !0 : window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t => t.cssText), this.localName))
        }
        ...
        update(t) {
            super.update(t);
            const e = this.render();
            e instanceof r.TemplateResult && this.constructor.render(e, this.renderRoot, {scopeName: this.localName, eventContext: this}), this._needsShimAdoptedStyleSheets && (this._needsShimAdoptedStyleSheets = !1, this.constructor._styles.forEach(t => {
    ...
    N.finalized = !0, N.render = (t, e, n) => {
        if (!n || "object" != typeof n || !n.scopeName) throw new Error("The `scopeName` option is required.");
        const r = n.scopeName, i = l.a.has(e), s = d && 11 === e.nodeType && !!e.host, a = s && !m.has(r), c = a ? document.createDocumentFragment() : e;
        if (Object(l.b)(t, c, Object.assign({templateFactory: f(r)}, n)), a) {
            const t = l.a.get(c);
            l.a.delete(c);
            const n = t.value instanceof h.a ? t.value.template : void 0;
            g(r, c, n), Object(o.b)(e, e.firstChild), e.appendChild(c), l.a.set(e, t)
        }
    ...
    const r = void 0 !== window.customElements && void 0 !== window.customElements.polyfillWrapFlushCallback, o = (t, e, n = null, r = null) => {
        for (; e !== n;) {
    ...
    class o {
        handleAttributeExpressions(t, e, n, o) {
            ...
            return "@" === i ? [new r.d(t, e.slice(1), o.eventContext)] : "?" === i ? [new r.c(t, e.slice(1), n)] : new r.a(t, e, n).parts
        }
    ...
    const i = new o;
    var s = n(13), a = n(11), c = n(5), l = n(4), u = n(12), h = n(10), p = n(15), d = n(0);
    n.d(e, "html", (function () {
        return f
    })), n.d(e, "svg", (function () {
        return y
    ...
    const f = (t, ...e) => new s.b(t, e, "html", i), y = (t, ...e) => new s.a(t, e, "svg", i)
}, function (t, e) {
    t.exports = function () {
    ...
    e.Environment = r, e.getQueryParams = o, e.env = function () {
        return e.ENV
    }, e.ENV = null, e.setEnvironmentGlobal = function (t) {
        e.ENV = t
    }
}, function (t, e, n) {
    "use strict";
    ...
    function o(t) {
        let e = i.get(t.type);
        void 0 === e && (e = {stringsArray: new WeakMap, keyString: new Map}, i.set(t.type, e));
        let n = e.stringsArray.get(t.strings);
        if (void 0 !== n) return n;
        const o = t.strings.join(r.f);
        return n = e.keyString.get(o), void 0 === n && (n = new r.a(t, t.getTemplateElement()), e.keyString.set(o, n)), e.stringsArray.set(t.strings, n), n
    }
    ...
    var r = n(5), o = n(1), i = n(10);
    const s = new WeakMap, a = (t, e, n) => {
        let a = s.get(e);
        void 0 === a && (Object(r.b)(e, e.firstChild), s.set(e, a = new o.e(Object.assign({templateFactory: i.b}, n))), a.appendInto(e)), a.setValue(t), a.commit()
    }
}, function (t, e, n) {
    "use strict";
    n.d(e, "b", (function () {
    ...
    class s {
        ...
        getHTML() {
            ...
            let e = "", n = !1;
            for (let r = 0; r < t; r++) {
                const t = this.strings[r], s = t.lastIndexOf("\x3c!--");
                n = (s > -1 || n) && -1 === t.indexOf("--\x3e", s + 1);
                const a = o.e.exec(t);
                e += null === a ? t + (n ? i : o.g) : t.substr(0, a.index) + a[1] + a[2] + o.b + a[3] + o.f
            }
    ...
    class a extends s {
        ...
        getTemplateElement() {
            const t = super.getTemplateElement(), e = t.content, n = e.firstChild;
    ...
    class i {
        ...
        _clone() {
            const t = r.a ? this.template.element.content.cloneNode(!0) : document.importNode(this.template.element.content, !0), e = [], n = this.template.parts, i = document.createTreeWalker(t, 133, null, !1);
            let s, a = 0, c = 0, l = i.nextNode();
            for (; a < n.length;) if (s = n[a], Object(o.d)(s)) {
                for (; c < s.index;) c++, "TEMPLATE" === l.nodeName && (e.push(l), i.currentNode = l.content), null === (l = i.nextNode()) && (i.currentNode = e.pop(), l = i.nextNode());
                if ("node" === s.type) {
    ...
    class s extends o.LitElement {
        constructor() {
            super(...arguments), this.label = "", this.iconType = "", this.disabled = !1
        }

        click(t) {
            t && t.stopPropagation(), this.dispatchEvent(new CustomEvent("click", {bubbles: !0, composed: !0}))
        }
    ...
    r([o.property({type: String})], s.prototype, "label", void 0), r([o.property({type: String})], s.prototype, "iconType", void 0), r([o.property({type: Boolean})], s.prototype, "disabled", void 0), r([i.default], s.prototype, "click", null), e.ButtonElement = s, customElements.define("tm-button", s)
}, function (t, e) {
    ...
    (function (t) {
        ...
        e.encodeWeights = function (t, e) {
            return r(this, void 0, void 0, (function () {
                var n, i, s, a, l, u = this;
                return o(this, (function (h) {
                    switch (h.label) {
                        case 0:
                            for (n = [], i = [], s = Array.isArray(t) ? t.map((function (t) {
                                return t.name
                            })) : Object.keys(t), a = function (a) {
                                var c = s[a], l = Array.isArray(t) ? t[a].tensor : t[c];
                                if ("float32" !== l.dtype && "int32" !== l.dtype && "bool" !== l.dtype && "string" !== l.dtype) throw new Error("Unsupported dtype in weight '" + c + "': " + l.dtype);
                                var h = {name: c, shape: l.shape, dtype: l.dtype};
                                if ("string" === l.dtype) {
                                                ...
                                                switch (o.label) {
                                                    ...
                                                    case 1:
                                                        for (e = o.sent(), n = e.reduce((function (t, e) {
                                                            return t + e.length
                                                        }), 0) + 4 * e.length, r = new Uint8Array(n), i = 0, s = 0; s < e.length; s++) a = e[s], c = new Uint8Array(new Uint32Array([a.length]).buffer), r.set(c, i), i += 4, r.set(a, i), i += a.length;
                                                        return t(r), [2]
                                                }
                                            }))
                                        }))
                            ...
                            }, l = 0; l < s.length; ++l) a(l);
                            return [4, Promise.all(i)];
                        case 1:
                            return [2, {data: c(h.sent()), specs: n}]
                    }
                }))
            }))
        }, e.decodeWeights = function (t, e) {
            for (var n = {}, r = 0, o = function (e) {
                var o = e.name, c = e.dtype, l = e.shape, u = s.sizeFromShape(l), h = void 0;
                if ("quantization" in e) {
                    var p = e.quantization;
                    if ("uint8" !== p.dtype && "uint16" !== p.dtype) throw new Error("Weight " + e.name + " has unknown quantization dtype " + p.dtype + ". Supported quantization dtypes are: 'uint8' and 'uint16'.");
                    var d = a.DTYPE_VALUE_SIZE_MAP[p.dtype], f = t.slice(r, r + u * d), y = "uint8" === p.dtype ? new Uint8Array(f) : new Uint16Array(f);
                    if ("float32" === c) h = Float32Array.from(y, (function (t) {
                        return t * p.scale + p.min
                    })); else {
                        if ("int32" !== c) throw new Error("Unsupported dtype in weight '" + o + "': " + c);
                    ...
                    f = t.slice(r, r + u * w);
                    if ("float32" === c) h = new Float32Array(f); else if ("int32" === c) h = new Int32Array(f); else {
                        if ("bool" !== c) throw new Error("Unsupported dtype in weight '" + o + "': " + c);
                        h = new Uint8Array(f)
                    }
                    r += u * w
                }
        ...
        var l = void 0 !== t && ("undefined" == typeof Blob || "undefined" == typeof atob || "undefined" == typeof btoa);

        function u(e) {
            return l ? t.byteLength(e) : new Blob([e]).size
        }

        e.stringByteLength = u, e.arrayBufferToBase64String = function (e) {
            return l ? t.from(e).toString("base64") : btoa(String.fromCharCode.apply(null, new Uint8Array(e)))
        }, e.base64StringToArrayBuffer = function (e) {
            if (l) {
                var n = t.from(e, "base64");
                return n.buffer.slice(n.byteOffset, n.byteOffset + n.byteLength)
            }
            for (var r = atob(e), o = new Uint8Array(r.length), i = 0; i < r.length; ++i) o.set([r.charCodeAt(i)], i);
            return o.buffer
            ...
            return {dateSaved: new Date, modelTopologyType: "JSON", modelTopologyBytes: null == t.modelTopology ? 0 : u(JSON.stringify(t.modelTopology)), weightSpecsBytes: null == t.weightSpecs ? 0 : u(JSON.stringify(t.weightSpecs)), weightDataBytes: null == t.weightData ? 0 : t.weightData.byteLength}
        }
    ...
    e.IORouterRegistry = r, e.registerSaveRouter = function (t) {
    ...
    "use strict";
    var r, o = this && this.__decorate || function (t, e, n, r) {
        var o, i = arguments.length, s = i < 3 ? e : null === r ? r = Object.getOwnPropertyDescriptor(e, n) : r;
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(t, e, n, r); else for (var a = t.length - 1; a >= 0; a--) (o = t[a]) && (s = (i < 3 ? o(s) : i > 3 ? o(e, n, s) : o(e, n)) || s);
        return i > 3 && s && Object.defineProperty(e, n, s), s
    };
    Object.defineProperty(e, "__esModule", {value: !0});
    const i = n(3), s = n(27), a = n(8), c = n(61), l = n(62), u = n(63);
    var h;
    !function (t) {
    ...
    let d = r = class extends s.WebcamElement {
        constructor() {
            super(...arguments), this.firstUpdate = !0, this.tapMediaStream = (t, e, n, r) => {
                if (s.defaultTapMediaStream(t, e, n, r), "function" == typeof r.getCapabilities) {
                    const t = r.getCapabilities(), n = {width: e.width, height: e.height};
                    if (p(n) !== p({width: t.width.max, height: t.height.max})) {
                        const t = e.width;
                        e.width = e.height, e.height = t, r.applyConstraints(e)
                    }
                }
            }, this.edit = !1, this.cropLeft = r.defaultCrop.left, this.cropTop = r.defaultCrop.top, this.cropWidth = r.defaultCrop.width, this.cropHeight = r.defaultCrop.height, this.minCropWidth = 64, this.minCropHeight = 64, this.aspect = 1, this.paused = !1, this.__isScalingCrop = !1
        }

        update(t) {
            if (t.has("edit") && this.video && this.sourceCtx && !this.firstUpdate) {
                const t = this.shadowRoot.querySelector("#container"), {videoWidth: e, videoHeight: n} = this.video;
                this.edit ? (this.scaledVideoWidth = this.width, this.scaledVideoHeight = n / e * this.width, t.style.height = `${this.scaledVideoHeight}px`, this.dispatchEvent(new CustomEvent("beginCrop"))) : (this.scaledVideoWidth = this.width, this.scaledVideoHeight = this.height, t.style.height = `${this.scaledVideoHeight}px`, this.dispatchEvent(new CustomEvent("endCrop")))
            }
        ...
        resetWebcam() {
            ...
            this.firstUpdate = !0, this.cropTop = t, this.cropLeft = e, this.cropWidth = n, this.cropHeight = o
        }

        __handleCropPanStart(t) {
            if (this.__isScalingCrop) return;
            l.isTouchEvent(t) && t.preventDefault();
            const e = [this.cropLeft, this.cropTop], n = l.mousePositionFromEvent(t, this), r = [NaN, NaN], o = [NaN, NaN], i = [this.cropLeft, this.cropTop], s = t => {
                l.mousePositionFromEvent(t, this, null, r), c.add(e, c.sub(r, n, o), i);
                const {videoWidth: s, videoHeight: a} = this.video;
                this.cropTop + this.cropHeight <= this.scaledVideoHeight && (this.cropLeft = u.clamp(i[0], 0, this.scaledVideoWidth - this.cropWidth), this.cropTop = u.clamp(i[1], 0, this.scaledVideoHeight - this.cropHeight))
            }, a = () => {
                this.__isScalingCrop = !1, this.removeEventListener("mousemove", s), this.removeEventListener("touchmove", s), document.removeEventListener("mouseup", a), document.removeEventListener("touchend", a)
            };
            this.addEventListener("mousemove", s), this.addEventListener("touchmove", s), document.addEventListener("mouseup", a), document.addEventListener("touchend", a)
        }

        __handleCropResizeStart(t) {
            this.__isScalingCrop = !0, l.isTouchEvent(t) && t.preventDefault();
            const e = t.target.id, {videoWidth: n, videoHeight: r} = this.video, o = this.cropWidth, i = [this.cropLeft, this.cropTop];
            let s;
            switch (e) {
                ...
                case"crop-tl-grabber":
                    ...
                    break;
                default:
                    s = c.add(i, c.scale([o, o], .5))
            }
            const a = l.mousePositionFromEvent(t, this), u = c.distance(s, a), h = t => {
                const i = l.mousePositionFromEvent(t, this), a = c.distance(s, i), h = Math.max(o + (a - u) / Math.sqrt(2), this.minCropWidth), p = this.cropLeft + this.cropWidth, d = this.cropTop + this.cropHeight, f = d - h >= 0, y = p - h >= 0, m = this.cropLeft + h <= this.width, g = this.cropTop + h <= r / n * this.height;
                switch (e) {
                    case"crop-br-grabber":
                        m && g && (this.cropWidth = this.cropHeight = h);
                        break;
                    case"crop-tr-grabber":
                        m && f && (this.cropWidth = this.cropHeight = h, this.cropTop = d - h);
                        break;
                    case"crop-bl-grabber":
                        g && y && (this.cropWidth = this.cropHeight = h, this.cropLeft = p - h);
                        break;
                    case"crop-tl-grabber":
                        y && f && (this.cropWidth = this.cropHeight = h, this.cropLeft = p - h, this.cropTop = d - h)
                }
            }, p = () => {
                this.__isScalingCrop = !1, this.removeEventListener("mousemove", h), this.removeEventListener("touchmove", h), document.removeEventListener("mouseup", p), document.removeEventListener("touchend", p)
            };
            this.addEventListener("mousemove", h), this.addEventListener("touchmove", h), document.addEventListener("mouseup", p), document.addEventListener("touchend", p)
        }

        __toggleCrop() {
            if (!this.video || !this.sourceCtx || this.firstUpdate) return;
            Array.from(this.shadowRoot.querySelectorAll(".webcam-button")).forEach(t => t.blur()), this.edit = !this.edit
        }
        ...
        _renderCameraToSourceCanvas() {
            ...
            let r;
            this.firstUpdate && (this.cropWidth = this.cropHeight = e / t * this.height, this.cropLeft = (this.width - this.cropWidth) / 2, this.firstUpdate = !1), r = this.isFlipped() ? t - this.cropLeft * n - this.cropWidth * n : this.cropLeft * n;
            const o = this.edit ? 0 : r, i = this.edit ? 0 : this.cropTop * n, s = this.edit ? t : this.cropWidth * n, a = this.edit ? e : this.cropHeight * n, c = this.width, l = this.edit ? this.height * (e / t) : this.height;
            return super._renderCameraToSourceCanvas(o, i, s, a, 0, 0, c, l)
        }
    };
    d.defaultCrop = {left: 0, top: 0, width: 265, height: 265}, o([i.property({type: Boolean, reflect: !0})], d.prototype, "edit", void 0), o([i.property({type: Number, reflect: !0})], d.prototype, "cropLeft", void 0), o([i.property({type: Number})], d.prototype, "cropTop", void 0), o([i.property({type: Number})], d.prototype, "cropWidth", void 0), o([i.property({type: Number})], d.prototype, "cropHeight", void 0), o([i.property({type: Number})], d.prototype, "minCropWidth", void 0), o([i.property({type: Number})], d.prototype, "minCropHeight", void 0), o([i.property({type: Number})], d.prototype, "scaledVideoWidth", void 0), o([i.property({type: Number})], d.prototype, "scaledVideoHeight", void 0), o([i.property({type: Number})], d.prototype, "aspect", void 0), o([i.property({
        type: Boolean,
        reflect: !0
    })], d.prototype, "paused", void 0), o([a.default], d.prototype, "__handleCropPanStart", null), o([a.default], d.prototype, "__handleCropResizeStart", null), d = r = o([i.customElement("tm-croppable-webcam")], d), e.CroppableWebcamElement = d
}, function (t, e, n) {
    "use strict";
    (function (t, r) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var s, a = n(9), c = n(94), l = n(95), u = n(96), h = n(30), p = n(98), d = n(2), f = n(2), y = function () {
            function t() {
            ...
            return t.prototype.ready = function () {
                    ...
                    return i(this, (function (o) {
                        switch (o.label) {
                            ...
                            case 3:
                                ...
                                o.label = 4;
                            case 4:
                                return this.backendInstance = this.registry[t], this.setupRegisteredKernels(), this.profiler = new l.Profiler(this.backendInstance), [2, !0]
                        }
                    }))
                }))
                ...
                try {
                    ...
                    if (Promise.resolve(r) === r) {
                        var o = ++this.pendingBackendInitId, i = r.then((function (n) {
                ...
                var i = this.state.numDataMovesStack[this.state.numDataMovesStack.length - 1], s = r - e - o - i;
                ...
                var u, h = [], p = this.isTapeOn(), d = null != this.state.activeScope ? this.state.activeScope.name : "", f = function (t) {
                    p && (h = t.map((function (t) {
                        return l.keep(l.clone(t))
                    })))
                }, y = this.state.numBytes, m = this.state.numTensors;
                this.shouldCheckForMemLeaks() && this.state.numDataMovesStack.push(0);
                var g, v = c.getKernel(r, this.backendName);
                return u = null != v ? function () {
                    var t = l.backend.numDataIds();
                    g = v.kernelFunc({inputs: e, attrs: o, backend: l.backend});
                    var n = Array.isArray(g) ? g : [g];
                    l.shouldCheckForMemLeaks() && l.checkKernelForMemLeak(d, t, n);
                    ...
                    var n = Array.isArray(g) ? g : [g];
                    return l.shouldCheckForMemLeaks() && l.checkKernelForMemLeak(d, e, n), n
                }, this.scopedRun((function () {
                    return l.state.kernelDepth++
                }), (function () {
                    return l.state.kernelDepth--
                }), (function () {
                    a = l.ENV.getBool("DEBUG") ? l.profiler.profileKernel(d, e, (function () {
                        return u()
                    })) : u()
                })), p && this.addTapeNode(d, e, a, n, h), this.state.profiling && this.state.activeProfile.kernels.push({
                    name: d, bytesAdded: this.state.numBytes - y, totalBytesSnapshot: this.state.numBytes, tensorsAdded: this.state.numTensors - m, totalTensorsSnapshot: this.state.numTensors, inputShapes: Object.keys(e).map((function (t) {
                        return e[t].shape
                ...
                var o = t;
                "string" === n && d.isString(t[0]) && (o = t.map((function (t) {
                    return d.encodeString(t)
                })));
                var i = r.write(o, e, n), s = new h.Tensor(e, n, i, this.nextTensorId());
                if (this.incRef(s, r), "string" === n) {
                    var a = this.state.tensorInfo.get(i), c = f.bytesFromStringArray(o);
                ...
                if (this.state.numTensors++, "string" === t.dtype && this.state.numStringTensors++, 0 === n) {
                    ...
                    var r = 0;
                    "complex64" !== t.dtype && "string" !== t.dtype && (r = t.size * d.bytesPerElement(t.dtype)), this.state.tensorInfo.set(t.dataId, {backend: e || this.backend, dtype: t.dtype, shape: t.shape, bytes: r, refCount: 0}), this.state.numBytes += r
                }
                this.state.tensorInfo.get(t.dataId).refCount++, t instanceof h.Variable || this.track(t)
                ...
                var i = this, s = {id: this.state.nextTapeNodeId++, name: t, inputs: e, outputs: n, saved: o};
                null != r && (s.gradient = function (t) {
                    return t = t.map((function (t, e) {
                        if (null == t) {
                            var r = n[e], o = d.makeZerosTypedArray(r.size, r.dtype);
                ...
                for (var e = this, n = p.getTensorsInContainer(t), r = new Set(n.map((function (t) {
                    return t.id
                ...
                var i = this;
                if (void 0 === o && (o = !1), d.assert(n.length > 0, (function () {
                    return "gradients() received an empty list of xs."
                })), null != r && "float32" !== r.dtype) throw new Error("dy must have 'float32' dtype, but has '" + r.dtype + "'");
                ...
                if (!o && 0 === a.length && n.length > 0) throw new Error("Cannot compute gradient of y=f(x) with respect to x. Make sure that the f you passed encloses all operations that lead from x to y.");
                return this.tidy("backward", (function () {
                    var t, o, c = {};
                    c[s.id] = null == r ? (t = s.shape, o = f.makeOnesTypedArray(f.sizeFromShape(t), "float32"), e.ENGINE.makeTensor(o, t, "float32")) : r, u.backpropagateGradients(c, a, (function (t) {
                        return i.tidy(t)
                    }));
                    ...
                    })), i.state.activeTape = null), {value: s, grads: l}
                }))
            }, t.prototype.customGrad = function (t) {
                var e = this;
                return d.assert(d.isFunction(t), (function () {
                    return "The f passed in customGrad(f) must be a function."
                })), function () {
                    for (var n, r = [], o = 0; o < arguments.length; o++) r[o] = arguments[o];
                    d.assert(r.every((function (t) {
                    ...
                    return r.forEach((function (t, e) {
                        ...
                        return n = t.apply(void 0, r.concat([o])), d.assert(n.value instanceof h.Tensor, (function () {
                            return "The function f passed in customGrad(f) must return an object where `obj.value` is a tensor"
                        })), d.assert(d.isFunction(n.gradFunc), (function () {
                            return "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function."
                        })), n.value
                    }), i, (function (t, e) {
                        var o = n.gradFunc(t, e), i = Array.isArray(o) ? o : [o];
                        d.assert(i.length === r.length, (function () {
                            return "The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function that returns the same number of tensors as inputs passed to f(...)."
                        })), d.assert(i.every((function (t) {
                            return t instanceof h.Tensor
                        })), (function () {
                ...
                for (var t in this.pendingBackendInitId++, this.state.dispose(), this.ENV.reset(), this.state = new y, this.registry) this.disposeRegisteredKernels(t), this.registry[t].dispose(), delete this.registry[t];
                this.backendName = null, this.backendInstance = null, this.pendingBackendInit = null
            }, t.nextTensorId = 0, t.nextVariableId = 0, t
        }();
        e.Engine = m, e.ENGINE = function () {
            var e = function () {
                if (null == s) {
                    var e = void 0;
            ...
            return a.setEnvironmentGlobal(e._tfengine.ENV), h.setTensorTracker((function () {
                return e._tfengine
            })), e._tfengine
        }()
    }).call(this, n(21), n(25))
    ...
    }), i = n(58), s = n(59), a = {requestAnimationFrame: s, cancelAnimationFrame: s.cancel};
    ...
    var l = function (t) {
        function e(e) {
            ...
            return n.fixedDelta = !1, n.frameCount = 0, n.deltaTime = 0, n.elapsedTime = 0, n.__completed = !1, n.__delay = 0, n.__fps = 1 / 0, n.__isReadyForUpdate = c, n.__lastTime = 0, n.__requestAnimationFrameObject = a, n.__running = !1, "number" == typeof e.delay && (n.__delay = e.delay), void 0 !== e.fixedDelta && (n.fixedDelta = !!e.fixedDelta), n.setFPS(e.fps || 1 / 0), n.setRequestAnimationFrameObject(e.requestAnimationFrameObject || a), n
        }

        return o(e, t), e.prototype.complete = function () {
            return this.stop(), this.__completed = !0, this.emit("complete", this.frameCount, this.deltaTime), this
            ...
            return this.stop(), this.__completed = !1, this.__lastTime = 0, this.deltaTime = 0, this.elapsedTime = 0, this.frameCount = 0, this.emit("reset", 0, 0, this.frameCount), this
        }, e.prototype.setFPS = function (t) {
            return this.__fps = t, this.__isReadyForUpdate = function (t) {
                var e = 1e3 / t, n = Date.now();
            ...
            if ("function" != typeof t.requestAnimationFrame || "function" != typeof t.cancelAnimationFrame) throw new Error("Invalid object provide to `setRequestAnimationFrameObject`");
            return this.__requestAnimationFrameObject = t, this
        }, e.prototype.start = function () {
            var t = this, n = function () {
                var n;
                if (t.__running) return t;
                e.instancesRunning += 1, t.__running = !0, t.__lastTime = Date.now(), t.deltaTime = 0, t.emit("start", t.deltaTime, 0, t.frameCount);
                var r = t.__requestAnimationFrameObject, o = function () {
                    var e = t.getRequestAnimationFrameObject();
                    if (r !== e) return r = e, void e.requestAnimationFrame(o);
                    t.__isReadyForUpdate() && t.update(), t.__running ? n = e.requestAnimationFrame(o) : e.cancelAnimationFrame(n)
                };
                return t.getRequestAnimationFrameObject().requestAnimationFrame(o), t
            };
            return this.__delay ? setTimeout(n, this.__delay) : n(), this
        }, e.prototype.stop = function () {
            return this.__running && (this.__running = !1, e.instancesRunning -= 1, this.emit("stop", this.deltaTime, this.elapsedTime, this.frameCount)), this
        }, e.prototype.update = function () {
            this.frameCount++;
            var t = Date.now();
            return this.__lastTime = this.__lastTime || t, this.deltaTime = this.fixedDelta || e.globalFixedDelta ? 1e3 / Math.min(60, this.__fps) : t - this.__lastTime, this.elapsedTime += this.deltaTime, this.__lastTime = t, this.emit("update", this.deltaTime, this.elapsedTime, this.frameCount), this
        }, e.instancesRunning = 0, e.globalFixedDelta = !1, e
    }(i), u = function (t) {
    ...
    function p(t, e) {
        return "function" == typeof t.bind ? t.bind(e) : function () {
            return t.apply(e, arguments)
        }
    }

    h.Animitter = l, h.bound = function (t, e) {
        for (var n, r = h(t, e), o = function (t) {
            for (var e = Object.keys(t), n = [], r = 0; r < e.length; r++) "function" == typeof t[e[r]] && n.push(e[r]);
            return n
        }(l.prototype), i = !!Function.prototype.bind, s = 0; s < o.length; s++) r[n = o[s]] = i ? r[n].bind(r) : p(r[n], r);
        return r
    }, h.EventEmitter = i, Object.defineProperty(h, "running", {
        get: function () {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const s = n(3), a = n(8), c = n(22), l = n(64);
    n(16), n(28), n(71);
    const u = n(72);
    let h = r = class extends l.AbstractSampleInputElement {
        constructor() {
            super(), this.buttonLabel = "webcam", this.buttonSVG = "M18 6V10.48L22 6.5V17.5L18 13.52V14.52V18C18 19.1 17.1 20 16 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4H16C17.1 4 18 4.9 18 6ZM16 14.52V9.69V6H4V18H16V14.52Z", this.webcamThrottle = r.lastWebcamThrottle, this.holdToRecord = r.lastHoldToRecord, this.recordDelay = r.lastRecordDelay, this.recordDuration = r.lastRecordDuration, this.autoPlay = !1, this.autoRecord = !1, this.settings = !1, this.showRecord = !1, this.___isAddingFrames = !1, this.maxSamples = 16
        }
        ...
        set _shouldAddFrame(t) {
            t !== this._shouldAddFrame && (this.___isAddingFrames = t, this[t ? "_dispatchRecordStart" : "_dispatchRecordStop"]())
        }
        ...
        play(t = {}) {
            void 0 === t.deviceId && r.lastDeviceId && (t.deviceId = r.lastDeviceId), this.__webcamElement.play(t).then(() => {
                if (this.__webcamElement.currentMediaStreamTrack) {
                    const t = this.__webcamElement.currentMediaStreamTrack.getSettings();
        ...
        update(t) {
            ...
            if ((t.has("open") || t.has("disabled")) && (this.open && (this.autoPlay || this.autoRecord) && !this.disabled ? this.play() : this.stop()), !1 === t.get("settings") || !1 === t.get("open")) {
                const t = this.shadowRoot.querySelector("#fps");
                this.webcamThrottle = r.lastWebcamThrottle, t.value = r.lastWebcamThrottle.toString(), this.shadowRoot.querySelector("#hold-to-record").checked = r.lastHoldToRecord;
                const e = this.shadowRoot.querySelector("#delay");
                this.recordDelay = r.lastRecordDelay, e.value = (r.lastRecordDelay / 1e3).toString();
                const n = this.shadowRoot.querySelector("#duration");
                this.recordDuration = r.lastRecordDuration, n.value = (r.lastRecordDuration / 1e3).toString()
            }
            return t.has("settings") && this.dispatchEvent(new CustomEvent(this.settings ? "settings" : "settingsexit", {bubbles: !0})), super.update(t)
        }

        __handleWebcamFrame(t) {
            return i(this, void 0, void 0, (function* () {
                this.isRecording && this.addSample(yield this.mapAsyncSample(this, this.__webcamElement.sourceCanvas))
            }))
        }
        ...
        __updateTapFrameAsync() {
            this.__webcamElement && (null != this._tapAsyncPreview ? this.__webcamElement.tapFrameAsync = (t, e, n) => i(this, void 0, void 0, (function* () {
                return yield this._tapAsyncPreview(this, e, n)
            })) : this.__webcamElement.tapFrameAsync = null)
        }

        firstUpdated(t) {
            this.__webcamElement = this.shadowRoot.querySelector("#webcam"), this.__updateTapFrameAsync(), super.firstUpdated(t)
        }

        __saveSettings() {
            r.lastWebcamThrottle = this.webcamThrottle, r.lastHoldToRecord = this.holdToRecord, r.lastRecordDelay = this.recordDelay, r.lastRecordDuration = this.recordDuration, u.default.setWebcamSetting({webcamThrottle: r.lastWebcamThrottle, holdToRecord: r.lastHoldToRecord, recordDelay: r.lastRecordDelay, recordDuration: r.lastRecordDuration})
        }

        __handleHoldToRecordStart(t) {
            "touchstart" === t.type && t.preventDefault(), this._shouldAddFrame = !0;
            const e = () => {
                this._shouldAddFrame = !1, document.removeEventListener("mouseup", e), document.removeEventListener("touchend", e)
            };
            document.addEventListener("mouseup", e), document.addEventListener("touchend", e)
        }

        __handleWebcamStatus(t) {
            const e = this.shadowRoot.querySelector("#webcam-container"), n = this.shadowRoot.querySelector("#webcam-error");
            t ? (n.style.display = "none", e.style.display = "block") : (e.style.display = "none", n.style.display = "flex"), this.settings = !1
        }

        __handleCrop(t) {
            this.shadowRoot.querySelector("#crop-btn").style.display = t && this.showRecord ? "block" : "none", this.shadowRoot.querySelector("#show-record").style.visibility = t ? "hidden" : "visible"
        }
            ...
            <div id="container">
                <div id="webcam-container">
                    <tm-media-device-select
                        ...
                        @change=${function (e) {
                const n = e.target;
                t.play({deviceId: n.value}), this.shadowRoot.querySelector("#webcam").resetWebcam(), this.dispatchEvent(new CustomEvent("devicechange", {bubbles: !0}))
            }}>
                    </tm-media-device-select>
                    <tm-croppable-webcam
                ...
                this.isPlaying || t.target.play()
                    ...
                    <div id="show-record" style=${this.showRecord ? "" : "display: none;"}>
                        ...
                        <tm-button
                            ...
                            @keydown=${t => {
                32 !== t.keyCode && 13 !== t.keyCode || (this._shouldAddFrame = !0)
            }}
                            @keyup=${() => {
                        ...
                        <div class="setting-option">
                            ...
                            <div class="input-holder">
                                <input id="fps" type="number" min="1" max="60" value=${this.webcamThrottle}
                                    @input=${t => {
                const e = t.target;
                this.webcamThrottle = parseInt(e.value, 10)
            }} min="1"/>
                            </div>
                        </div>
                            ...
                            <div class="setting-option">
                                ...
                                <div class="input-holder">
                                    <input id="delay" type="number" min="0" value=${this.recordDelay / 1e3}
                                        @change=${t => {
                this.recordDelay = 1e3 * Number(t.target.value)
            }} min="0"/>
                                    seconds
                                </div>
                            </div>
                            ...
                            <div class="setting-option">
                                ...
                                <div class="input-holder">
                                    <input id="duration" type="number" min="0" value=${this.recordDuration / 1e3}
                                        @change=${t => {
                this.recordDuration = 1e3 * Number(t.target.value)
            }} min="0"/>
                                    seconds
                                </div>
                            </div>
                ...
                this.settings = !1
                            ...
                            <tm-button
                                ...
                                label="Save Settings"
                                @click=${() => {
                this.__saveSettings(), this.settings = !1
            }}>
                            </tm-button>
                        </div>
                </div>
    ...
    h.middleSlotName = "middle", h.lastWebcamThrottle = null !== u.default.getWebcamSetting("webcamThrottle") ? Number(u.default.getWebcamSetting("webcamThrottle")) : 24, h.lastHoldToRecord = null === u.default.getWebcamSetting("holdToRecord") || u.default.getWebcamSetting("holdToRecord"), h.lastRecordDelay = null !== u.default.getWebcamSetting("recordDelay") ? Number(u.default.getWebcamSetting("recordDelay")) : 2e3, h.lastRecordDuration = null !== u.default.getWebcamSetting("recordDuration") ? Number(u.default.getWebcamSetting("recordDuration")) : 6e3, o([s.property({type: String})], h.prototype, "buttonLabel", void 0), o([s.property({type: String})], h.prototype, "buttonSVG", void 0), o([s.property({type: Number})], h.prototype, "webcamThrottle", void 0), o([s.property({type: Boolean})], h.prototype, "holdToRecord", void 0), o([s.property({type: Number})], h.prototype, "recordDelay", void 0), o([s.property({type: Number})], h.prototype, "recordDuration", void 0), o([s.property({
        type: Boolean,
        reflect: !0
    })], h.prototype, "autoPlay", void 0), o([s.property({type: Boolean})], h.prototype, "autoRecord", void 0), o([s.property({type: Boolean, reflect: !0})], h.prototype, "settings", void 0), o([s.property({type: Boolean, reflect: !0})], h.prototype, "showRecord", void 0), o([a.default], h.prototype, "__handleWebcamFrame", null), o([a.default], h.prototype, "__handleHoldToRecordStart", null), h = r = o([s.customElement("tm-webcam-sample-input")], h), e.WebcamSampleInput = h
}, function (t, e, n) {
    "use strict";
    var r, o = this && this.__decorate || function (t, e, n, r) {
        var o, i = arguments.length, s = i < 3 ? e : null === r ? r = Object.getOwnPropertyDescriptor(e, n) : r;
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const s = n(3), a = n(8), c = n(32), l = n(33), u = document.createElement("canvas");

    function h() {
        return i(this, void 0, void 0, (function* () {
            return (yield l.enumerateDevices()).filter(t => "videoinput" === t.kind)
        }))
    }

    e.getAllWebcamDeviceInfo = h;
    const p = t => (t => t.srcObject && t.srcObject instanceof MediaStream)(t) ? t.srcObject : null;
    e.stopAllTracks = t => {
        t.pause(), p(t) && p(t).getTracks().forEach(t => {
            t.stop()
        })
    ...
    let d = r = class extends l.AbstractUserMediaElement {
        constructor() {
            super(...arguments), this.stats = !1, this.throttle = 0, this.deviceWidth = -1, this.deviceHeight = -1, this.tapFrameAsync = null, this.deviceId = "none", this.tapMediaStream = e.defaultTapMediaStream, this._isReadyForNextFrame = !0, this.__videoElement = document.createElement("video"), this.__frameCount = 0, this._lastMediaTrackConstraints = {}, this.__skipNextUpdatingConstraints = !1
        }
        ...
        get sourceCtx() {
            ...
            return t ? (this.__sourceCtx = t.getContext("2d"), this.__sourceCtx) : null
        }
        ...
        play(t) {
            return t && (this.__promiseGetWebcam = null), void 0 === (t = t || {}).deviceId && "string" == typeof this.deviceId && (t.deviceId = this.deviceId), !(t.width > 0) && this.deviceWidth > 0 && (t.width = this.deviceWidth), !(t.height > 0) && this.deviceHeight > 0 && (t.height = this.deviceHeight), this.__promiseGetWebcam && this.__promiseHasResized || (this._isInitialized = !1, this.__promiseHasResized = new Promise(t => {
                const e = () => {
                    this.video.videoWidth * this.video.videoHeight < 4 || (this.video.removeEventListener("timeupdate", e), this._isInitialized = !0, t())
                };
                this.video.addEventListener("timeupdate", e)
            }), this.__promiseGetWebcam = l.getUserMedia({video: t}).catch(t => {
                console.log(t), this._isOk = !1, this.dispatchEvent(new CustomEvent("webcamReject", {bubbles: !0}))
            }).then(t => {
                ...
                const {video: r} = this;
                if (this.__curentMediaStreamTrack = e, this._lastMediaTrackConstraints = n, this.deviceId = n && "string" == typeof n.deviceId ? n.deviceId : "default", r) return r.play().then(() => (this._isOk = !0, r.videoWidth === this.deviceWidth && r.videoHeight === this.deviceHeight || (this.deviceWidth = r.videoWidth, this.deviceHeight = r.videoHeight, this.__skipNextUpdatingConstraints = !0), this.dispatchEvent(new CustomEvent("webcamAccept", {bubbles: !0})), r))
            })), Promise.all([this.__promiseGetWebcam, this.__promiseHasResized]).then(this._handleLoopPlay)
        }

        stop() {
            return this.__promiseGetWebcam ? this.__promiseGetWebcam.then(() => {
                e.stopAllTracks(this.video), this._loop && this._loop.stop(), this.__promiseGetWebcam = this.__promiseHasResized = null, this.dispatchEvent(new CustomEvent("stop"))
        ...
        _renderCameraToSourceCanvas(t = 0, e = 0, n = this.deviceWidth, o = this.deviceHeight, i = 0, s = 0, a = this.sourceCanvas.width, c = this.sourceCanvas.height) {
            if (!this.video || !this.sourceCtx) return;
            const l = this.sourceCtx;
            l.canvas.width = a, l.canvas.height = c, r.flip ? (i = -a, l.scale(-1, 1), l.drawImage(this.video, t, e, n, o, i, s, a, c)) : l.drawImage(this.video, t, e, n, o, i, s, a, c)
        }

        update(t) {
            if (t.has("deviceWidth") || t.has("deviceHeight")) if (this.__skipNextUpdatingConstraints) this.__skipNextUpdatingConstraints = !1; else {
                const t = Object.assign({}, this._lastMediaTrackConstraints, {width: -1, height: -1});
                this.isPlaying && this.stop().then(() => this.play(t))
            }
            return super.update(t)
        }

        copySourceToCanvas(t, e = this.sourceCanvas.width, n = this.sourceCanvas.height) {
            const r = c.getContext2D(t) || document.createElement("canvas").getContext("2d");
            return r !== this.sourceCtx && (r.canvas.width = e, r.canvas.height = n, r.drawImage(this.sourceCanvas, 0, 0, e, n)), r
        }
        ...
        toCanvas(t, e = this.sourceCanvas.width, n = this.sourceCanvas.height) {
            return i(this, void 0, void 0, (function* () {
                ...
                return o.canvas.width = e, o.canvas.height = n, o.drawImage(u, 0, 0, e, n), o.canvas
            }))
        }
        ...
        _handleLoopUpdate(t, e, n) {
            return i(this, void 0, void 0, (function* () {
                if (this._isReadyForNextFrame) {
                    if (this._renderCameraToSourceCanvas(), yield this.toCanvas(this.canvas, this.sourceCanvas.width, this.sourceCanvas.height), this.stats) {
                        const e = Math.floor(1e3 / t);
                        this.canvas;
                        this._ctx.fillStyle = "black", this._ctx.fillRect(0, this.height - 30, 80, 30), this._ctx.font = "16px Arial", this._ctx.fillStyle = "red", this._ctx.fillText(`${e}fps`, 15, this.height - 10)
                    }
    ...
    d.flip = !0, o([s.property({type: Boolean, reflect: !0})], d.prototype, "stats", void 0), o([s.property({type: Number})], d.prototype, "throttle", void 0), o([s.property({type: Number, reflect: !0})], d.prototype, "width", void 0), o([s.property({type: Number, reflect: !0})], d.prototype, "height", void 0), o([s.property({type: Number, reflect: !0})], d.prototype, "deviceWidth", void 0), o([s.property({type: Number, reflect: !0})], d.prototype, "deviceHeight", void 0), o([s.property({type: String})], d.prototype, "deviceId", void 0), o([a.default], d.prototype, "_handleLoopUpdate", null), d = r = o([s.customElement("tm-webcam")], d), e.WebcamElement = d
}, function (t, e, n) {
    "use strict";
    var r = this && this.__decorate || function (t, e, n, r) {
        var o, i = arguments.length, s = i < 3 ? e : null === r ? r = Object.getOwnPropertyDescriptor(e, n) : r;
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const o = n(24), i = n(3), s = n(8), a = (t, e, n) => t === -e ? `Record ${Math.floor(n / 1e3)} Seconds` : t < 0 ? `Recording in ${Math.ceil(-1 * t / 1e3)}s...` : `Recording ${Math.floor(t / 1e3)}s...`;
    let c = class extends i.LitElement {
        constructor() {
            super(...arguments), this.delayOnComplete = 1e3, this.cancelable = !0, this.delay = 0, this.duration = 1, this.fps = 60, this.hideProgress = !1, this.__isActive = !1, this.label = "", this.labelGenerator = a
        }
        ...
        get ready() {
            return this._loop && this._delayLoop && !(this._delayLoop.isRunning() || this._loop.isRunning())
        }

        connectedCallback() {
            return this._delayLoop = new o.Animitter, this._delayLoop.on("update", this._handleDelayUpdate), this._delayLoop.on("complete", this._handleDelayComplete), this._loop = new o.Animitter, this._loop.on("start", this._handleLoopStart), this._loop.on("update", this._handleLoopUpdate), this._loop.on("complete", this._handleLoopComplete), this._loop.on("stop", this._handleLoopStop), super.connectedCallback()
        }

        disconnectedCallback() {
            return this._delayLoop.dispose(), this._loop.dispose(), super.disconnectedCallback()
        }
        ...
        _handleDelayUpdate(t, e) {
            this._updateFill(e / this.delay), this._updateLabel(), this.dispatchEvent(new CustomEvent("delayupdate", {bubbles: !0})), e >= this.delay && this._delayLoop.complete()
        }

        _handleDelayComplete() {
            this.dispatchEvent(new CustomEvent("delaycomplete", {bubbles: !0})), this._delayLoop.stop(), this._loop.start()
        }

        _handleLoopStart() {
            this.__isActive = !0, this.dispatchEvent(new CustomEvent("start", {bubbles: !0}))
        }

        _handleLoopStop() {
            this.__isActive = !1, this.dispatchEvent(new CustomEvent("stop", {bubbles: !0}))
        }

        _handleLoopComplete() {
            this.dispatchEvent(new CustomEvent("complete", {bubbles: !0})), setTimeout(() => {
                this._updateFill(0), this._resetLoops(), this._updateLabel()
            }, this.delayOnComplete)
        }

        _handleLoopUpdate(t, e) {
            this._updateFill(e / this.duration), this._updateLabel(), this.dispatchEvent(new CustomEvent("update", {bubbles: !0})), e >= this.duration && this._loop.complete()
        }

        _updateLabel() {
            const t = this._delayLoop.elapsedTime - this.delay + this._loop.elapsedTime, e = this.labelGenerator(t, this.delay, this.duration);
            this._buttonElement.label = e
        }

        _resetLoops() {
            this._delayLoop.reset(), this._loop.reset(), this._loop.setFPS(this.fps)
        }

        cancel() {
            return !(!this.cancelable || !this._delayLoop.isRunning() && !this._loop.isRunning()) && (this._delayLoop.stop(), this._delayLoop.reset(), this._loop.stop(), this._loop.reset(), this._updateLabel(), this.dispatchEvent(new CustomEvent("cancel", {bubbles: !0})), !0)
        }

        start() {
            this.cancel() || (this._resetLoops(), this.delay > 0 && isFinite(this.delay) ? this._delayLoop.start() : this._handleDelayComplete())
        }

        firstUpdated(t) {
            return this._fillElement = this.shadowRoot.querySelector("#fill"), this._buttonElement = this.shadowRoot.querySelector("tm-button"), this._updateLabel(), super.firstUpdated(t)
        }
    ...
    let s = class extends o.LitElement {
        constructor() {
            super(...arguments), this.value = 0, this.min = 0, this.max = 1, this.label = "", this.disabled = !1
        }
    ...
    r([o.property({type: Number})], s.prototype, "value", void 0), r([o.property({type: Number})], s.prototype, "min", void 0), r([o.property({type: Number})], s.prototype, "max", void 0), r([o.property({type: String})], s.prototype, "label", void 0), r([o.property({type: Boolean, reflect: !0})], s.prototype, "disabled", void 0), r([i.default], s.prototype, "click", null), s = r([o.customElement("tm-progress-button")], s), e.ProgressButtonElement = s
}, function (t, e, n) {
    "use strict";
    var r, o = this && this.__extends || (r = function (t, e) {
        return (r = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var a = n(97), c = n(2), l = n(2), u = function () {
        function t(t, e, n) {
            var r = this;
            if (this.dtype = e, this.shape = t.slice(), this.size = c.sizeFromShape(t), null != n) {
                var o = n.length;
            ...
            this.values = n || c.getArrayFromDType(e, this.size), this.strides = l.computeStrides(t)
        }

        return t.prototype.set = function (t) {
            for (var e = this, n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
            0 === n.length && (n = [0]), c.assert(n.length === this.rank, (function () {
            ...
            for (var a = t[t.length - 1], c = 0; c < t.length - 1; ++c) a += this.strides[c] * t[c];
    ...
    var f = function () {
        function t(t, e, n, r) {
            this.kept = !1, this.isDisposedInternal = !1, this.shape = t.slice(), this.dtype = e || "float32", this.size = c.sizeFromShape(t), this.strides = l.computeStrides(t), this.dataId = n, this.id = r, this.rankType = this.rank < 5 ? this.rank.toString() : "higher"
        }

        return t.prototype.flatten = function () {
            return this.throwIfDisposed(), this.as1D()
        }, t.prototype.asScalar = function () {
            return this.throwIfDisposed(), c.assert(1 === this.size, (function () {
            ...
            return i(this, void 0, void 0, (function () {
                ...
                return s(this, (function (n) {
                    switch (n.label) {
                        case 0:
                            return this.throwIfDisposed(), t = h().read(this.dataId), "string" !== this.dtype ? [3, 2] : [4, t];
                        case 1:
                            e = n.sent();
                            try {
            ...
            this.isDisposed || (h().disposeTensor(this), this.isDisposedInternal = !0)
            ...
            return void 0 === t && (t = 0), void 0 === e && (e = !1), void 0 === n && (n = !1), p.cumsum(this, t, e, n)
            ...
            return void 0 === e && (e = 0), this.throwIfDisposed(), p.gather(this, t, e)
        }, t.prototype.matMul = function (t, e, n) {
            return void 0 === e && (e = !1), void 0 === n && (n = !1), this.throwIfDisposed(), p.matMul(this, t, e, n)
        }, t.prototype.dot = function (t) {
            return this.throwIfDisposed(), p.dot(this, t)
        }, t.prototype.norm = function (t, e, n) {
            return void 0 === t && (t = "euclidean"), void 0 === e && (e = null), void 0 === n && (n = !1), this.throwIfDisposed(), p.norm(this, t, e, n)
            ...
            return void 0 === n && (n = 0), this.throwIfDisposed(), e instanceof t && (e = [e]), p.concat([this].concat(e), n)
        }, t.prototype.split = function (t, e) {
            return void 0 === e && (e = 0), this.throwIfDisposed(), p.split(this, t, e)
            ...
            return void 0 === n && (n = .001), d("tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon"), this.batchNorm(t, e, o, r, n)
        }, t.prototype.batchNorm = function (t, e, n, r, o) {
            return void 0 === o && (o = .001), this.throwIfDisposed(), p.batchNorm(this, t, e, n, r, o)
        }, t.prototype.all = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.all(this, t, e)
        }, t.prototype.any = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.any(this, t, e)
        }, t.prototype.logSumExp = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.logSumExp(this, t, e)
        }, t.prototype.sum = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.sum(this, t, e)
        }, t.prototype.prod = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.prod(this, t, e)
        }, t.prototype.mean = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.mean(this, t, e)
        }, t.prototype.min = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.min(this, t, e)
        }, t.prototype.max = function (t, e) {
            return void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), p.max(this, t, e)
        }, t.prototype.argMin = function (t) {
            return void 0 === t && (t = null), this.throwIfDisposed(), p.argMin(this, t)
        }, t.prototype.argMax = function (t) {
            return void 0 === t && (t = null), this.throwIfDisposed(), p.argMax(this, t)
            ...
            return void 0 === t && (t = .2), this.throwIfDisposed(), p.leakyRelu(this, t)
            ...
            return void 0 === t && (t = 0), this.throwIfDisposed(), p.step(this, t)
        },t.prototype.softmax = function (t) {
            return void 0 === t && (t = -1), this.throwIfDisposed(), p.softmax(this, t)
        },t.prototype.logSoftmax = function (t) {
            return void 0 === t && (t = -1), this.throwIfDisposed(), p.logSoftmax(this, t)
        },t.prototype.resizeBilinear = function (t, e) {
            return void 0 === e && (e = !1), this.throwIfDisposed(), p.image.resizeBilinear(this, t, e)
        },t.prototype.resizeNearestNeighbor = function (t, e) {
            return void 0 === e && (e = !1), this.throwIfDisposed(), p.image.resizeNearestNeighbor(this, t, e)
        },t.prototype.conv1d = function (t, e, n, r, o, i) {
            return void 0 === r && (r = "NWC"), void 0 === o && (o = 1), this.throwIfDisposed(), p.conv1d(this, t, e, n, r, o, i)
        },t.prototype.conv2d = function (t, e, n, r, o, i) {
            return void 0 === r && (r = "NHWC"), void 0 === o && (o = [1, 1]), this.throwIfDisposed(), p.conv2d(this, t, e, n, r, o, i)
            ...
            return void 0 === r && (r = "NHWC"), void 0 === o && (o = [1, 1]), this.throwIfDisposed(), p.depthwiseConv2d(this, t, e, n, r, o, i)
        },t.prototype.separableConv2d = function (t, e, n, r, o, i) {
            return void 0 === o && (o = [1, 1]), void 0 === i && (i = "NHWC"), this.throwIfDisposed(), p.separableConv2d(this, t, e, n, r, o, i)
            ...
            return void 0 === t && (t = 5), void 0 === e && (e = 1), void 0 === n && (n = 1), void 0 === r && (r = .5), p.localResponseNormalization(this, t, e, n, r)
        },t.prototype.pool = function (t, e, n, r, o) {
            return this.throwIfDisposed(), p.pool(this, t, e, n, r, o)
        },t.prototype.variable = function (t, e, n) {
            return void 0 === t && (t = !0), this.throwIfDisposed(), h().makeVariable(this, t, e, n)
            ...
            return void 0 === t && (t = 1), void 0 === e && (e = !0), this.throwIfDisposed(), p.topk(this, t, e)
        },t.prototype.stridedSlice = function (t, e, n, r, o, i, s, a) {
            return void 0 === r && (r = 0), void 0 === o && (o = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === a && (a = 0), this.throwIfDisposed(), p.stridedSlice(this, t, e, n, r, o, i, s, a)
    ...
    e.Tensor = f, Object.defineProperty(f, Symbol.hasInstance, {
        value: function (t) {
    ...
    var y = function (t) {
        ...
        return o(e, t), e.prototype.assign = function (t) {
            if (t.dtype !== this.dtype) throw new Error("dtype of the new value (" + t.dtype + ") and previous value (" + this.dtype + ") must match");
            if (!c.arraysEqual(t.shape, this.shape)) throw new Error("shape of the new value (" + t.shape + ") and previous value (" + this.shape + ") must match");
            h().disposeTensor(this), this.dataId = t.dataId, h().incRef(this, null)
        }, e.prototype.dispose = function () {
            h().disposeVariable(this), this.isDisposedInternal = !0
        }, e
    }(f);
    e.Variable = y, Object.defineProperty(y, Symbol.hasInstance, {
        value: function (t) {
            return t instanceof f && null != t.assign && t.assign instanceof Function
        }
    })
}, function (t, e, n) {
    "use strict";
    ...
    var i = n(2), s = n(20), a = function () {
        ...
        return t.getInstance = function () {
            ...
            })), e.endsWith("://") && (e = e.slice(0, e.indexOf("://"))), i.assert(e.length > 0, (function () {
    ...
    function c(t) {
        if (-1 === t.indexOf("://")) throw new Error("The url string provided does not contain a scheme. Supported schemes are: " + a.getSchemes().join(","));
    ...
    function l(t, e, n) {
        return void 0 === n && (n = !1), r(this, void 0, void 0, (function () {
            ...
            return o(this, (function (o) {
                switch (o.label) {
                    case 0:
                        return i.assert(t !== e, (function () {
                            return "Old path and new path are the same: '" + t + "'"
                        })), r = s.IORouterRegistry.getLoadHandlers(t), i.assert(r.length > 0, (function () {
                        ...
                        })), l = r[0], u = s.IORouterRegistry.getSaveHandlers(e), i.assert(u.length > 0, (function () {
                        ...
                        })), h = u[0], p = c(t).scheme, d = c(t).path, f = p === c(t).scheme, [4, l.load()];
                    case 1:
                        return y = o.sent(), n && f ? [4, a.getManager(p).removeModel(d)] : [3, 3];
                    case 2:
                        o.sent(), o.label = 3;
                    case 3:
                        return [4, h.save(y)];
                    case 4:
                        return m = o.sent(), !n || f ? [3, 6] : [4, a.getManager(p).removeModel(d)];
                    case 5:
                        o.sent(), o.label = 6;
                    case 6:
    ...
    e.ModelStoreManagerRegistry = a, e.listModels = function () {
        return r(this, void 0, void 0, (function () {
            var t, e, n, r, i, s, c;
            return o(this, (function (o) {
                switch (o.label) {
                    ...
                    case 1:
                        return n < r.length ? (i = r[n], [4, a.getManager(i).listModels()]) : [3, 4];
                    case 2:
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const o = () => document.createElement("canvas"), i = t => t && t.width && t.width.animVal, s = t => i(t) ? t.width.animVal.value : t.width, a = t => i(t) ? t.height.animVal.value : t.height;

    function c(t, e, n = o()) {
        return n.width = s(t) * e, n.height = a(t) * e, n.getContext("2d").drawImage(t, 0, 0, n.width, n.height), n
    }

    e.resize = c, e.resizeMaxTo = function (t, e, n = o()) {
        return c(t, e / Math.max(s(t), a(t)), n)
    }, e.resizeMinTo = function (t, e, n = o()) {
        return c(t, e / Math.min(s(t), a(t)), n)
    }, e.cropTo = function (t, e, n = o()) {
        const r = s(t), i = a(t), c = e / Math.min(r, i), l = Math.ceil(r * c), u = Math.ceil(i * c), h = l - e, p = u - e;
        return n.width = n.height = e, n.getContext("2d").drawImage(t, -1 * Math.floor(h / 2), -1 * Math.floor(p / 2), l, u), n
    ...
    }, e.isCanvas = t => t && "function" == typeof t.getContext, e.isCanvasImageSource = t => t && (e.isCanvas(t) || t.tagName && -1 !== ["video", "img"].indexOf(t.tagName.toLowerCase())), e.getContext2D = t => e.isCanvas(t) ? t.getContext("2d") : t, e.toBlob = (t, e) => r(void 0, void 0, void 0, (function* () {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const o = n(3), i = n(24), s = n(8);
    e.defaultVideoOptions = {frameRate: 30};
    const a = "Your browser does not support WebRTC. Please try another one.";

    function c() {
        return window.navigator && navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && navigator.mediaDevices.getUserMedia
    }

    function l() {
        return c() ? navigator.mediaDevices.enumerateDevices() : Promise.reject(a)
    }

    function u(t) {
        return c() ? window.navigator.mediaDevices.getUserMedia(t) : Promise.reject(a)
    }

    e.assertHasWebRTC = function () {
        if (!c()) throw new Error(a)
    }, e.hasWebRTC = c, e.enumerateDevices = l, e.getUserMedia = u, e.getWebcam = function (t = document.createElement("video"), n = e.defaultVideoOptions) {
        return u({
            video: n = function (t) {
                return t.facingMode = t.facingMode || e.defaultVideoOptions.facingMode, t.frameRate = t.frameRate || e.defaultVideoOptions.frameRate, t.width = t.width || e.defaultVideoOptions.width, t.height = t.height || e.defaultVideoOptions.height, t
            }(n)
        }).then(e => (t.srcObject = e, t), () => Promise.reject("Could not open your camera. You may have denied access."))
    }, e.getMicrophoneStream = function (t) {
        return u({audio: {deviceId: t}, video: !1}).then(t => t, () => Promise.reject("Could not open your microphone stream. You may have denied access."))
    };

    class h extends o.LitElement {
        constructor() {
            super(...arguments), this.autoplay = !1, this.throttle = 0, this.deviceId = "none", this._isReadyForNextFrame = !0, this._isInitialized = !1, this._isOk = !0
        }
        ...
        get throttledFrameRate() {
            return this.throttle > 0 ? Math.min(this.throttle, this.frameRate) : this.frameRate
        }
        ...
        disconnectedCallback() {
            ...
            t < 0 ? console.warn("Disconnecting from dom but was never attached") : h.__instances.splice(t, 1), this.stop(), super.disconnectedCallback()
        }
        ...
        _handleLoopPlay() {
            return this.dispatchEvent(new CustomEvent("play")), this._loop && this._loop.stop(), this._loop = new i.Animitter({fps: this.throttledFrameRate}), this._loop.on("update", this._handleLoopUpdate), this._loop.start(), this
        }

        update(t) {
            return t.get("throttle") && this._loop && this._loop.setFPS(this.throttledFrameRate), super.update(t)
        }

        _dispatchUpdate(t, e, n) {
            this.dispatchEvent(new CustomEvent("update", {composed: !0, detail: {deltaTime: t, elapsedTime: e, frameCount: n}}))
        }
    }

    h.__instances = [], r([o.property({type: Boolean})], h.prototype, "autoplay", void 0), r([o.property({type: Number})], h.prototype, "throttle", void 0), r([s.default], h.prototype, "_handleLoopPlay", null), e.AbstractUserMediaElement = h
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.fastMap = (t, e, n) => {
        n = n || [];
        ...
        let r = t.length;
        for (; r--;) {
            const t = Math.floor((r + 1) * Math.random()), e = n[t];
            n[t] = n[r], n[r] = e
        }
        return n.slice(0, e)
    }
    ...
    let i = class extends o.LitElement {
        constructor() {
            super(...arguments), this.colors = "#ff0000 #00ff00 #ffffff", this.value = 0, this.max = 1, this.label = "", this.display = "value"
        }

        render() {
            const {colors: t, value: e, max: n, label: r} = this, [i, s, a] = t.split(" "), c = e / n, l = Math.round(100 * c);
            return o.html`
            <style>
                :host {
                    height: 29px;
    ...
    r([o.property({type: String})], i.prototype, "colors", void 0), r([o.property({type: Number})], i.prototype, "value", void 0), r([o.property({type: Number})], i.prototype, "max", void 0), r([o.property({type: String})], i.prototype, "label", void 0), r([o.property({type: String, reflect: !0})], i.prototype, "display", void 0), i = r([o.customElement("tm-bar-graph")], i), e.BarGraphElement = i
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    const r = n(3);
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(14), s = n(14), a = n(39), c = n(40), l = n(41);
    e.IMAGE_SIZE = 224;
    var u = function (t) {
        return t.packageVersion = t.packageVersion || l.version, t.packageName = t.packageName || "@teachablemachine/image", t.timeStamp = t.timeStamp || (new Date).toISOString(), t.userMetadata = t.userMetadata || {}, t.modelName = t.modelName || "untitled", t.labels = t.labels || [], t
    }, h = function (t, e) {
        if (1 === t) {
                ...
                switch (o.label) {
                    ...
                    case 1:
                        return r = o.sent(), [2, i.tidy((function () {
                            ...
                            for (var e = [], o = 0; o < r.length; o++) e.push({value: r[o], index: o});
                            e.sort((function (t, e) {
                                return e.value - t.value
                            }));
                            var i = new Float32Array(n), s = new Int32Array(n);
                            for (o = 0; o < n; o++) i[o] = e[o].value, s[o] = e[o].index;
                            var a = [];
                            for (o = 0; o < s.length; o++) a.push({className: t[s[o]], probability: i[o]});
                            return a
                        }))]
                }
            }))
    ...
    var f = function () {
        ...
        return Object.defineProperty(t, "EXPECTED_IMAGE_SIZE", {
            ...
            return void 0 === n && (n = 10), void 0 === l && (l = !1), r(this, void 0, void 0, (function () {
                var r, u, h, p = this;
                return o(this, (function (o) {
                    switch (o.label) {
                        case 0:
                            return r = c.cropTo(t, e.IMAGE_SIZE, l), u = i.tidy((function () {
                                var t = a.capture(r);
            ...
            return void 0 === n && (n = !1), r(this, void 0, void 0, (function () {
                var r, l, u, h, p, d = this;
                return o(this, (function (o) {
                    switch (o.label) {
                        case 0:
                            return r = c.cropTo(t, e.IMAGE_SIZE, n), [4, (l = i.tidy((function () {
                                var t = a.capture(r);
                                return d.model.predict(t)
                            }))).data()];
                        case 1:
                            for (u = o.sent(), h = [], p = 0; p < u.length; p++) h.push({className: this._metadata.labels[p], probability: u[p]});
    ...
    e.CustomMobileNet = f, e.loadTruncatedMobileNet = function (t) {
        return r(this, void 0, void 0, (function () {
            var n, r, s, a, c, l, u;
            return o(this, (function (o) {
                switch (o.label) {
                    case 0:
                        return n = function (t) {
                            ...
                            if (t.version = t.version || 1, 1 === t.version) {
                                t.alpha = t.alpha || .25, t.alpha = h(t.version, t.alpha), console.log("Loading mobilenet " + t.version + " and alpha " + t.alpha);
                            ...
                            if (2 === t.version) return t.alpha = t.alpha || .35, t.alpha = h(t.version, t.alpha), console.log("Loading mobilenet " + t.version + " and alpha " + t.alpha), ["https://storage.googleapis.com/teachable-machine-models/mobilenet_v2_weights_tf_dim_ordering_tf_kernels_" + t.alpha.toFixed(2) + "_" + e.IMAGE_SIZE + "_no_top/model.json", "out_relu"];
                            throw new Error("MobileNet V" + t.version + " doesn't exist")
                        }(t), r = n[0], s = n[1], [4, i.loadLayersModel(r)];
                    case 1:
                        return a = o.sent(), t && 1 === t.version ? (c = a.getLayer(s), l = i.model({inputs: a.inputs, outputs: c.output}), (u = i.sequential()).add(l), u.add(i.layers.flatten()), [2, u]) : (c = a.getLayer(s), l = i.model({inputs: a.inputs, outputs: c.output}), (u = i.sequential()).add(l), u.add(i.layers.globalAveragePooling2d({})), [2, u])
                }
            }))
        }))
    }, e.load = function (t, e) {
    ...
    function o(t) {
        var e = Math.min(t.shape[0], t.shape[1]), n = t.shape[0] / 2 - e / 2, r = t.shape[1] / 2 - e / 2;
    ...
    e.resize = o, e.resizeMaxTo = function (t, e, n) {
        ...
        t instanceof HTMLVideoElement && (i = t.videoWidth, s = t.videoHeight);
        var a = e / Math.min(i, s), c = Math.ceil(i * a), l = Math.ceil(s * a), u = c - e, h = l - e;
        o.width = o.height = e;
        var p = o.getContext("2d");
        return p.drawImage(t, -1 * ~~(u / 2), -1 * ~~(h / 2), c, l), n && (p.scale(-1, 1), p.drawImage(o, -1 * e, 0)), o
    }
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    ...
    (function (e) {
        ...
        var s = n(85), a = Object.prototype.hasOwnProperty, c = Array.prototype.slice, l = "foo" === function () {
        }.name;
        ...
        var p = t.exports = v, d = /\s*function\s+([^\(\s]*)\s*/;
        ...
        function g(t, e, n, r, o) {
            throw new p.AssertionError({message: n, actual: t, expected: e, operator: r, stackStartFunction: o})
        }
        ...
        function b(t, e, n, r) {
            ...
            if (null !== t && "object" == typeof t || null !== e && "object" == typeof e) {
                if (h(t) && h(e) && u(t) === u(e) && !(t instanceof Float32Array || t instanceof Float64Array)) return 0 === o(new Uint8Array(t.buffer), new Uint8Array(e.buffer));
                if (i(t) !== i(e)) return !1;
                ...
                return -1 !== a && a === r.expected.indexOf(e) || (r.actual.push(t), r.expected.push(e), function (t, e, n, r) {
                    ...
                    for (l = u.length - 1; l >= 0; l--) if (a = u[l], !b(t[a], e[a], n, r)) return !1;
                    return !0
                }(t, e, n, r))
            }
            return n ? t === e : t == e
        ...
        function x(t, e, n, r) {
            ...
            "string" == typeof n && (r = n, n = null), o = function (t) {
                ...
                return e
            }(e), r = (n && n.name ? " (" + n.name + ")." : ".") + (r ? " " + r : "."), t && !o && g(o, n, "Missing expected exception" + r);
            var i = "string" == typeof r, a = !t && o && !n;
            if ((!t && s.isError(o) && i && _(o, n) || a) && g(o, n, "Got unwanted exception" + r), t && o && n && !_(o, n) || !t && o) throw o
        }
        ...
        p.AssertionError = function (t) {
        ...
        }, s.inherits(p.AssertionError, Error), p.fail = g, p.ok = v, p.equal = function (t, e, n) {
            t != e && g(t, e, n, "==", p.equal)
            ...
            e || g(e, !0, n, "==", t)
        }), p, {equal: p.strictEqual, deepEqual: p.deepStrictEqual, notEqual: p.notStrictEqual, notDeepEqual: p.notDeepStrictEqual}), p.strict.strict = p.strict;
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const o = n(14), i = n(44), s = n(102), a = n(107);
    ...
    class c extends i.HTTPRequest {
        ...
        save(t) {
            return r(this, void 0, void 0, (function* () {
                ...
                e.body = new FormData;
                const n = [{paths: ["./model.weights.bin"], weights: t.weightSpecs}], r = {modelTopology: t.modelTopology, format: t.format, generatedBy: t.generatedBy, convertedBy: t.convertedBy, weightsManifest: n};
                e.body.append("model.json", new Blob([JSON.stringify(r)], {type: "application/json"}), "model.json"), null != t.weightData && e.body.append("model.weights.bin", new Blob([t.weightData], {type: "application/octet-stream"}), "model.weights.bin"), e.body.append("metadata.json", new Blob([JSON.stringify(this.metadata)], {type: "application/json"}), "metadata.json");
                const i = yield o.util.fetch(this.path, e);
                if (i.ok) {
                    return {modelArtifactsInfo: s.getModelArtifactsInfoForJSON(t), responses: [i]}
                }
                throw new Error("MetadataBrowserHTTPRequest.save() failed due to HTTP response status " + `${i.status}.`)
            }))
        }
    }

    e.MetadataBrowserHTTPRequest = c, e.metadataBrowserHTTPRequest = function (t, e, n) {
        const r = {};
        return e && (r["x-token"] = n, r["x-model-name"] = e), new c(t, a.config.PUBLISH_URL, {requestInit: {method: "POST", headers: r}})
    }
}, function (t, e, n) {
    "use strict";
    var r = this && this.__awaiter || function (t, e, n, r) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(9), s = n(2), a = n(19), c = n(20), l = n(48), u = function () {
        function t(t, e) {
            if (this.DEFAULT_METHOD = "POST", null == e && (e = {}), this.weightPathPrefix = e.weightPathPrefix, this.onProgress = e.onProgress, null != e.fetchFunc ? (s.assert("function" == typeof e.fetchFunc, (function () {
                return "Must pass a function that matches the signature of `fetch` (see https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)"
            })), this.fetch = e.fetchFunc) : this.fetch = i.env().platform.fetch, s.assert(null != t && t.length > 0, (function () {
                return "URL path for http must not be null, undefined or empty."
            })), Array.isArray(t) && s.assert(2 === t.length, (function () {
        ...
        return t.prototype.save = function (t) {
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (o) {
                    switch (o.label) {
                        ...
                        case 1:
                            if ((i = o.sent()).ok) return [2, {modelArtifactsInfo: a.getModelArtifactsInfoForJSON(t), responses: [i]}];
            ...
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (o) {
                    switch (o.label) {
                        ...
                        case 5:
                            if (r = e.modelTopology, i = e.weightsManifest, null == r && null == i) throw new Error("The JSON from HTTP path " + this.path + " contains neither model topology or manifest for weights.");
                            return null == i ? [3, 7] : [4, this.loadWeights(i)];
                        case 6:
                            c = o.sent(), s = c[0], a = c[1], o.label = 7;
                        case 7:
                            return [2, {modelTopology: r, weightSpecs: s, weightData: a}]
                    }
                }))
            }))
            ...
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (o) {
                    switch (o.label) {
                        case 0:
                            for (e = Array.isArray(this.path) ? this.path[1] : this.path, n = h(e), r = n[0], i = n[1], s = this.weightPathPrefix || r, c = [], u = 0, p = t; u < p.length; u++) d = p[u], c.push.apply(c, d.weights);
                            return f = [], t.forEach((function (t) {
                                t.paths.forEach((function (t) {
                                    f.push(s + t + i)
                                }))
                            })), [4, l.loadWeightsAsArrayBuffer(f, {requestInit: this.requestInit, fetchFunc: this.fetch, onProgress: this.onProgress})];
                        case 1:
                            return y = o.sent(), [2, [c, a.concatenateArrayBuffers(y)]]
                    }
                }))
            }))
    ...
    function h(t) {
        var e = t.lastIndexOf("/"), n = t.lastIndexOf("?");
    ...
    e.HTTPRequest = u, e.parseUrl = h, e.isHTTPScheme = p, e.httpRouter = function (t, e) {
        if ("undefined" == typeof fetch) return null;
        return (Array.isArray(t) ? t.every((function (t) {
            return p(t)
        })) : p(t)) ? d(t, {onProgress: e}) : null
    }, c.IORouterRegistry.registerSaveRouter(e.httpRouter), c.IORouterRegistry.registerLoadRouter(e.httpRouter), e.http = d, e.browserHTTPRequest = function (t, e) {
        return d(t, e)
    }
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    var r = n(23), o = n(9), i = n(30), s = n(2);

    function a(t, e) {
        var n = t;
        if (s.isTypedArray(t)) return "string" === e ? [] : [t.length];
        if (!Array.isArray(t)) return [];
        for (var r = []; Array.isArray(n) || s.isTypedArray(n) && "string" !== e;) r.push(n.length), n = n[0];
        return Array.isArray(t) && o.env().getBool("TENSORLIKE_CHECK_SHAPE_CONSISTENCY") && function t(e, n, r) {
            if (r = r || [], !Array.isArray(e) && !s.isTypedArray(e)) return void s.assert(0 === n.length, (function () {
    ...
    function l(t, e, n, l) {
        if (void 0 === l && (l = "numeric"), t instanceof i.Tensor) return c(l, t.dtype, e, n), t;
        var u = s.inferDtype(t);
        if ("string" !== u && ["bool", "int32", "float32"].indexOf(l) >= 0 && (u = l), c(l, u, e, n), null == t || !s.isTypedArray(t) && !Array.isArray(t) && "number" != typeof t && "boolean" != typeof t && "string" != typeof t) {
            var h = null == t ? "null" : t.constructor.name;
            throw new Error("Argument '" + e + "' passed to '" + n + "' must be a Tensor or TensorLike, but got '" + h + "'")
        }
        var p = a(t, u);
        s.isTypedArray(t) || Array.isArray(t) || (t = [t]);
        var d = "string" !== u ? s.toTypedArray(t, u, o.env().getBool("DEBUG")) : s.flatten(t, [], !0);
        return r.ENGINE.makeTensor(d, p, u)
    }

    e.inferShape = a, e.convertToTensor = l, e.convertToTensorArray = function (t, e, n, r) {
    ...
    e.op = function (t) {
        ...
        var i = function () {
            ...
            try {
                ...
                return i instanceof Promise && console.error("Cannot return a Promise inside of tidy."), r.ENGINE.endScope(i), i
            } catch (t) {
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.DTYPE_VALUE_SIZE_MAP = {float32: 4, int32: 4, uint16: 2, uint8: 1, bool: 1}
}, function (t, e, n) {
    "use strict";
    var r = this && this.__awaiter || function (t, e, n, r) {
        return new (n || (n = Promise))((function (o, i) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(9), s = n(2), a = n(19), c = n(101), l = n(47);
    ...
    function u(t, e) {
        return r(this, void 0, void 0, (function () {
            ...
            return o(this, (function (o) {
                switch (o.label) {
                    case 0:
                        return null == e && (e = {}), n = null == e.fetchFunc ? i.env().platform.fetch : e.fetchFunc, r = t.map((function (t) {
                            return n(t, e.requestInit, {isBinary: !0})
                        })), s = 0, a = .5, null != e.onProgress ? [3, 2] : [4, Promise.all(r)];
                    case 1:
                        return l = o.sent(), [3, 4];
                    case 2:
                    ...
                    case 3:
                        l = o.sent(), o.label = 4;
                    case 4:
                        return u = l.map((function (t) {
                            return t.arrayBuffer()
                        })), h = .5, p = 1, null != e.onProgress ? [3, 6] : [4, Promise.all(u)];
                    case 5:
                        return d = o.sent(), [3, 8];
                    case 6:
                ...
                return o(this, (function (o) {
                    switch (o.label) {
                        case 0:
                            if (e = n.map((function () {
                                return !1
                            })), r = {}, u = null != c ? c.map((function () {
                                return !1
                            })) : [], h = [], n.forEach((function (t, n) {
                                var o = 0;
                                t.weights.forEach((function (t) {
                                    var i = "quantization" in t ? t.quantization.dtype : t.dtype, a = l.DTYPE_VALUE_SIZE_MAP[i] * s.sizeFromShape(t.shape), p = function () {
                                        e[n] = !0, null == r[n] && (r[n] = []), r[n].push({manifestEntry: t, groupOffset: o, sizeBytes: a})
                                    };
                                    null != c ? c.forEach((function (e, n) {
                                        e === t.name && (p(), u[n] = !0)
                                    })) : p(), h.push(t.name), o += a
                                }))
                            })), !u.every((function (t) {
                                return t
                            }))) throw p = c.filter((function (t, e) {
                                return !u[e]
                            })), new Error("Could not find weights in manifest with names: " + p.join(", ") + ". \nManifest JSON has weights with names: " + h.join(", ") + ".");
                            return d = e.reduce((function (t, e, n) {
                                return e && t.push(n), t
                        ...
                        case 1:
                            return y = o.sent(), m = {}, g = 0, d.forEach((function (t) {
                                for (var e = n[t].paths.length, o = 0, i = 0; i < e; i++) o += y[g + i].byteLength;
                                for (var s = new ArrayBuffer(o), c = new Uint8Array(s), l = 0, u = 0; u < e; u++) {
                                    var h = new Uint8Array(y[g + u]);
                                    c.set(h, l), l += h.byteLength
                                }
                                r[t].forEach((function (t) {
                                    var e = s.slice(t.groupOffset, t.groupOffset + t.sizeBytes), n = a.decodeWeights(e, [t.manifestEntry]);
    ...
    e.loadWeightsAsArrayBuffer = u, e.loadWeights = function (t, e, n, i) {
        return void 0 === e && (e = ""), r(this, void 0, void 0, (function () {
            return o(this, (function (r) {
                return [2, h((function (t) {
                    return u(t, {requestInit: i})
                }))(t, e, n)]
            }))
        }))
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), n(35), n(16), n(22), n(29), n(26), n(28), n(50), n(27), n(36), r(n(16)), r(n(22)), r(n(29)), r(n(27)), r(n(26)), r(n(28)), r(n(50));
    var o = n(109);
    e.version = o.version
}, function (t, e, n) {
    "use strict";
    ...
    let i = class extends o.LitElement {
        constructor() {
            super(...arguments), this.disabled = !1, this.hideLabel = !1, this.checked = !1, this.label = ""
        }
        ...
        render() {
            const {label: t, checked: e, value: n} = this, r = `${t}, toggled ${e ? "on" : "off"} `;
            return o.html`
            <style>
                :host {
                    display: block;
        ...
        update(t) {
            return t.has("checked") && void 0 !== t.get("checked") && this.dispatchEvent(new CustomEvent("change", {bubbles: !0})), super.update(t)
        }
    };
    r([o.property({type: Boolean})], i.prototype, "disabled", void 0), r([o.property({type: Boolean})], i.prototype, "hideLabel", void 0), r([o.property({type: Boolean})], i.prototype, "checked", void 0), r([o.property({type: String})], i.prototype, "label", void 0), i = r([o.customElement("tm-toggle")], i), e.ToggleElement = i
}, function (t, e, n) {
    "use strict";
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), r(n(52)), r(n(111)), r(n(43));
    var o = n(6);
    e.html = o.html
}, function (t, e, n) {
    "use strict";
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const i = n(53), s = n(49), a = n(42), c = n(110), l = n(8);
    e.barGraphPalette = [["#D84C6F", "#FFE9EC"], ["#794AEF", "#F1F0FF"], ["#1967D2", "#D2E3FC"], ["#E67701", "#FFECE2"]], e.defaultWizardSchema = {
        allowPublish: !0, autoLoad: !0, autoNext: !0, classes: [], input: "webcam", inputSettings: {}, modelOptions: {}, onOpen: () => {
        }, onClose: () => {
        }, onReady: () => {
        }, onPrediction: () => console.warn("Wizard onPrediction has not been added"), train: {title: "Train", description: "OK, let's train your model!"}, type: "image"
    };

    class u {
        constructor(t) {
            this.isReady = !1, this.schema = Object.assign({}, e.defaultWizardSchema);
            const n = Object.keys(this.schema);
            n.push(...Object.keys(t).filter(t => n.indexOf(t) < 0)), n.forEach(e => {
                var n, r;
                "object" == typeof this.schema[e] ? Object.assign(this.schema[e], t[e]) : null !== t[e] && void 0 !== t[e] && (n = this.schema, r = t[e], n[e] = r)
            }), this.schema.classes.forEach((t, n) => {
                t.color = t.color || e.barGraphPalette[n % e.barGraphPalette.length][0]
            }), console.log("schema: ", this.schema), a(this.schema.classes.length > 1, "schema.classes must have at least 2 classes"), this.buttonElement = new c.TeachableButtonElement, this.buttonElement.addEventListener("click", this.open), this.domElement = new i.WizardElement, this.domElement.inputSettings = this.schema.inputSettings, this.domElement.addEventListener("open", this.handleWizardOpen), this.domElement.addEventListener("close", this.handleWizardClose), this.schema.introduction && (this.schema.introduction.title && (this.domElement.introduction.title = this.schema.introduction.title), this.schema.introduction.description && (this.domElement.introduction.description = this.schema.introduction.description)), this.schema.autoLoad && this.load().then(() => t.onLoad && t.onLoad()), this.domElement.classes = this.schema.classes, t.onSampleAdded && this.domElement.addEventListener("sampleadd", e => {
                const n = e.detail;
                t.onSampleAdded(n)
            }), t.onTrain && this.domElement.addEventListener("train", () => t.onTrain()), t.onTrainComplete && this.domElement.addEventListener("traincomplete", () => t.onTrainComplete())
        }
        ...
        handleWizardClose(t) {
            this.schema.onClose(), !this.isReady && this.domElement.isTrained && (this.isReady = !0, this.schema.onReady())
        }

        open() {
            this.domElement.parentElement || document.body.appendChild(this.domElement), this.domElement.open = !this.domElement.open
        }
        ...
        createInferenceCamera(t = {}) {
            const e = Object.assign({deviceId: this.domElement.lastDeviceId}, u.defaultInferenceWebcamSettings, t), n = new s.CroppableWebcamElement;
            n.width = e.size, n.height = e.size, e.autoPlay ? n.play({deviceId: e.deviceId}) : n.deviceId = e.deviceId;
            let r = !0;
            return n.classList.add("tm-inference-camera"), n.addEventListener("update", () => o(this, void 0, void 0, (function* () {
    ...
    u.defaultInferenceWebcamSettings = {autoPlay: !0, size: 290}, r([l.default], u.prototype, "handleWizardOpen", null), r([l.default], u.prototype, "handleWizardClose", null), r([l.default], u.prototype, "open", null), e.Wizard = u
}, function (t, e, n) {
    "use strict";
    var r = this && this.__decorate || function (t, e, n, r) {
        var o, i = arguments.length, s = i < 3 ? e : null === r ? r = Object.getOwnPropertyDescriptor(e, n) : r;
    ...
    const s = n(36), a = n(8), c = n(37), l = n(42), u = n(88), h = n(43), p = n(108);
    let d = class extends i.LitElement {
        constructor() {
            super(...arguments), this.open = !1, this.classes = [], this.training = {
                title: "Train model", description: i.html`
            Okay! Now click “Train model” to process your images.`
            }, this.introduction = {
                title: "Welcome to the teachablemachine.js training wizard", description: t => i.html`
            You will be asked to train for classes ${t.classes.map((t, e, n) => i.html`
                    <span style=${"color: " + t.color}>${t.name}</span>${e < n.length - 1 ? ", " : ""}
                `)}
        `
            }, this.isRecordingSample = !1, this.stepIndex = 0, this.samples = [], this.canProgress = () => !0, this.__modelHasBeenTrained = !1, this.__lastDeviceId = "default"
        }
        ...
        addSample(t, e) {
            return o(this, void 0, void 0, (function* () {
                ...
                const n = () => o(this, void 0, void 0, (function* () {
                    yield this.model.addExample(t, e), this.__modelHasBeenTrained = !1, this.dispatchEvent(new CustomEvent("sampleadd", {detail: {index: t, name: this.classes[t], sample: e}}))
                }));
        ...
        loadModel(t = {}) {
            const e = Object.assign({}, {version: 2, alpha: .35}, t);
            return this.samples = [], c.createTeachable({tfjsVersion: "0.0.0", tmVersion: "0.0.0"}, e).then(t => (this.model = t, this.model.setLabels(this.classes.map(t => t.name)), this.model.warm(), Promise.resolve()))
        }

        train() {
            return o(this, void 0, void 0, (function* () {
                this.__modelHasBeenTrained = !1, this.dispatchEvent(new CustomEvent("train")), yield o(void 0, void 0, void 0, (function* () {
                    return new Promise(t => {
                        window.requestAnimationFrame(t)
                    })
                })), yield this.model.train({denseUnits: 100, epochs: 25, learningRate: .001, batchSize: 16}, {
                    onEpochBegin: t => o(this, void 0, void 0, (function* () {
                    })), onEpochEnd: t => o(this, void 0, void 0, (function* () {
                        console.log("on epoch end", t);
                        const e = this.shadowRoot.querySelector("#train-button");
                        e && (e.value = t / 24)
                    })), onTrainEnd: () => o(this, void 0, void 0, (function* () {
                        console.log("on train end")
                    }))
                }), this.__modelHasBeenTrained = !0, this.dispatchEvent(new CustomEvent("traincomplete")), console.log(`pre stepIndex: ${this.stepIndex}`), this.stepIndex++, console.log(`post stepIndex: ${this.stepIndex}, ${this.stepIndex - this.classes.length}`), this.requestUpdate()
            }))
        }

        firstUpdated(t) {
            return this.nextButton = this.shadowRoot.querySelector("#next tm-button"), this.backButton = this.shadowRoot.querySelector("#back tm-button"), super.firstUpdated(t)
        }
        ...
        renderClassifierCard(t) {
            ...
            if (t < 0 || t > e.length) throw new Error(`Invalid Classifier card requested, class ${t} does not exist`);
            this.backButton.disabled = !1, this.canProgress = () => this.samples && this.samples[t] && this.samples[t].length >= Math.max(e[t].minimum || 0, 1);
            const n = ((t, e) => {
                const n = Object.assign({}, t, e || {});
                if (n.frameRate = n.frameRate || 1 / 0, "number" == typeof n.recordSeconds) {
                    const t = n.delaySeconds;
                    n.delaySeconds = "number" == typeof t ? Math.max(0, t) : 0, n.holdToRecord = !1
                } else n.recordSeconds = -1, n.delaySeconds = -1, n.holdToRecord = !0;
                return n
            ...
            <div id="left-content">
                <div id="sample-input-container" class="flex-row">
                    <tm-webcam-sample-input
                        id="input-element"
                        @sample=${e => o(this, void 0, void 0, (function* () {
                const n = e.target, r = n.lastDisplaySample;
                if (yield this.addSample(t, r), n.webcamElement && n.webcamElement.currentMediaStreamTrack) {
                    const t = n.webcamElement.currentMediaStreamTrack.getSettings();
                ...
                const e = t.target;
                e && e.webcamElement && (this.__lastDeviceId = e.webcamElement.deviceId)
            }}
                        @devicechange=${t => {
                const e = t.target;
                e && e.webcamElement && (this.__lastDeviceId = e.webcamElement.deviceId)
                ...
                this.isRecordingSample = !1
                        ...
                        @settings=${() => {
                const t = this.shadowRoot.querySelector(".sample-counter");
        ...
        renderTrainCard() {
            ...
            for (let t = 0; t < this.classes.length; t++) {
                ...
                console.log(e);
                const n = this.classes[t], r = isFinite(n.minimum) && n.minimum || 1;
                l(e.length >= r, `Class ${n.name} does not meet minimum sample length of ${r}`)
            }
            return this.canProgress = () => this.isTrained, i.html`
            <div id="left-content">
                ...
                console.log(`samples: ${this.samples.map((t, e) => `[${e}] ${this.classes[e].name}: ${t.length}`)}`), yield this.train(), this.canProgress = () => !0, this.requestUpdate()
            }))}
                        ></tm-progress-button>
                    </div>
                </div>
            ...
            <div id="left-content" class="run">
                <div id="sample-input-container" class="flex-row">
                    <tm-webcam-sample-input
                        ...
                        @sample=${e => o(this, void 0, void 0, (function* () {
                if (!this.open) return;
                const n = e.target.lastDisplaySample, r = yield this.model.predict(n);
                t = t.length ? t : Array.from(this.shadowRoot.querySelectorAll("tm-bar-graph"));
                for (let e = 0; e < r.length; e++) {t[e].value = r[e].probability;}
            }))}
                        open
                        autorecord>
                    </tm-webcam-sample-input>
        ...
        renderPublishCard() {
            ...
            <h2>Publish your model for reuse</h2>
            ...
            <tm-button
                label="Publish"
                @click=${() => o(this, void 0, void 0, (function* () {
                console.log("publish", this.model.getMetadata());
                const t = h.metadataBrowserHTTPRequest(this.model.getMetadata());
                console.log(t);
                const e = (yield this.model.save(t)).responses[0], n = yield e.json();
                console.log("response", n), this.shadowRoot.querySelector("#waiting").innerHTML = `name: ${n.name}, token: ${n.token}`, p.addPublished(n)
            }))}></tm-button>
        ...
        getPart() {
            ...
            for (let e = 0; e < this.classes.length; e++) t.push(() => this.renderClassifierCard(e));
            t.push(() => this.renderTrainCard());
            t.push(() => this.renderRunCard());
            t.push(() => this.renderPublishCard());
            return t, t[this.stepIndex]();
        }
        ...
        render() {
            ...
            <ta-card>
                ...
                <div id="navigation" slot="navigation">
                    ...
                    <div id="back">
                        <tm-button ?disabled=${0 === this.stepIndex} label="Back" @click=${() => {
                this.stepIndex > 0 && (this.stepIndex--, this.requestUpdate())
            }}></tm-button>
                    </div>
                    <div id="next">
                        <tm-button ?disabled=${!this.canProgress()} label=${0 === this.stepIndex ? "Start" : this.stepIndex + 1 < this.totalSteps ? "Next" : "Done"} @click=${() => {
                this.stepIndex + 1 < this.totalSteps ? (this.stepIndex++, console.log("request update stepIndex", this.stepIndex), this.requestUpdate()) : this.open = !1
            }}></tm-button>
                    </div>
            </ta-card>
        `
        ...
        updated(t) {
            return t.has("open") && this.dispatchEvent(new CustomEvent(this.open ? "open" : "close", {bubbles: !0})), super.updated(t)
        }
    };
    r([i.property({type: Boolean, reflect: !0})], d.prototype, "open", void 0), r([i.property({type: Array})], d.prototype, "classes", void 0), r([i.property({type: Object})], d.prototype, "inputSettings", void 0), r([i.property({type: Object})], d.prototype, "training", void 0), r([i.property({type: Object})], d.prototype, "introduction", void 0), r([a.default], d.prototype, "renderIntroCard", null), r([a.default], d.prototype, "renderClassifierCard", null), r([a.default], d.prototype, "renderTrainCard", null), r([a.default], d.prototype, "renderRunCard", null), r([a.default], d.prototype, "renderPublishCard", null), d = r([i.customElement("ta-wizard")], d), e.WizardElement = d
}, function (t, e, n) {
    "use strict";
    var r = this && this.__decorate || function (t, e, n, r) {
        var o, i = arguments.length, s = i < 3 ? e : null === r ? r = Object.getOwnPropertyDescriptor(e, n) : r;
    ...
    r([o.property({type: Number})], s.prototype, "steps", void 0), r([o.property({type: Number})], s.prototype, "value", void 0), s = r([o.customElement("progress-bars")], s), e.ProgressBarsElement = s
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.copy = function (t, e = []) {
        if (t === e) return e;
        for (let n = 0; n < t.length; n++) e[n] = t[n];
        return e
    }, e.empty = (t, e = 0) => {
    ...
    e.filterCompare = (t, n, o = []) => {
        ...
        return s
    }, e.last = t => t[t.length - 1], e.map = (t, e, n = []) => {
        for (let r = 0; r < t.length; r++) n[r] = e(t[r], r, t);
        return n
    }, e.pluck = (t, e, n = []) => {
    ...
    let a = class extends o.LitElement {
        constructor() {
            super(), this.color = "red", this.samples = [], this.label = "", this.play = !1, this.fps = 10, this.showClassName = !0, this.loop = new i.Animitter, this.loop.on("update", this.handleLoopUpdate)
        }
        ...
        connectedCallback() {
            return this.play && this.hasUpdated > 0 && this.loop.start(), super.connectedCallback()
        }
        ...
        handleLoopUpdate(t, e, n) {
            ...
            this.sampleContainer.innerHTML = "", this.sampleContainer.appendChild(r)
        }

        firstUpdated(t) {
            return this.sampleContainer = this.shadowRoot.querySelector(".sample-preview-container"), this.play && this.loop.start(), super.firstUpdated(t)
        }

        updated(t) {
            return t.has("play") && this.loop[this.play ? "start" : "stop"](), t.has("fps") && this.loop.setFPS(this.fps), super.updated(t)
        }
    ...
    Object.create && (i.prototype = Object.create(null), (new i).__proto__ || (o = !1)), l.prototype.eventNames = function () {
        ...
        var c, l, u = this._events[a], h = arguments.length;
        if (u.fn) {
            ...
            for (l = 0; l < d; l++) switch (u[l].once && this.removeListener(t, u[l].fn, void 0, !0), h) {
                ...
                case 4:
                    ...
                    break;
                default:
                    if (!c) for (p = 1, c = new Array(h - 1); p < h; p++) c[p - 1] = arguments[p];
        ...
        if (s.fn) s.fn !== e || r && !s.once || n && s.context !== n || c(this, i); else {
            for (var a = 0, l = [], u = s.length; a < u; a++) (s[a].fn !== e || r && !s[a].once || n && s[a].context !== n) && l.push(s[a]);
    ...
    (function (e) {
        for (var r = n(60), o = "undefined" == typeof window ? e : window, i = ["moz", "webkit"], s = "AnimationFrame", a = o["request" + s], c = o["cancel" + s] || o["cancelRequest" + s], l = 0; !a && l < i.length; l++) a = o[i[l] + "Request" + s], c = o[i[l] + "Cancel" + s] || o[i[l] + "CancelRequest" + s];
        if (!a || !c) {
            var u = 0, h = 0, p = [];
            a = function (t) {
                if (0 === p.length) {
                    var e = r(), n = Math.max(0, 1e3 / 60 - (e - u));
    ...
    (function (e) {
        (function () {
            ...
            })(), a = 1e9 * e.uptime(), s = i - a) : Date.now ? (t.exports = function () {
                return Date.now() - o
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const r = n(34), o = t => t;
    e.add = (t, e, n) => r.fastMap(t, (t, n) => t + e[n], n), e.angleBetween = (t, e) => Math.atan2(e[1] - t[1], e[0] - t[0]), e.copy = (t, e = [NaN, NaN]) => r.fastMap(t, o, e), e.distance = (t, e) => Math.sqrt(Math.pow(t[0] - e[0], 2) + Math.pow(t[1] - e[1], 2)), e.equal = (t, e) => t[0] === e[0] && t[1] === e[1], e.lerp = function (t, e, n, r = [NaN, NaN]) {
        return r[0] = (e[0] - t[0]) * n + t[0], r[1] = (e[1] - t[1]) * n + t[1], r
    }, e.magnitude = ([t, e]) => t * t + e * e, e.normalize = (t, n = [NaN, NaN]) => {
        let r = e.magnitude(t);
        const [o, i] = t;
        return r > 0 && (r = 1 / Math.sqrt(r), n[0] = o * r, n[1] = i * r), n
    }, e.scale = (t, e, n) => r.fastMap(t, (t, n) => {
        return t * (r = e, Array.isArray(r) && 2 === r.length && "number" == typeof r[0] ? e[n] : e);
        var r
    }, n), e.sub = (t, e, n) => r.fastMap(t, (t, n) => t - e[n], n), e.toCartesian = function ([t, e], n = [NaN, NaN]) {
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.isTouchEvent = t => t && "string" == typeof t.type && 0 === t.type.indexOf("touch") && !!t.touches;
    ...
    function o(t, e = !0, n = [0, 0]) {
        ...
        if (r(t)) {
            ...
            o = (t => (t => null !== t && t === t.window)(t) ? t : 9 === t.nodeType && (t.defaultView || t.parentWindow))(i)
        } else n[0] = t.left, n[1] = t.top, o = window, i = document;
        const s = {x: 0, y: 0}, a = document.documentElement;
        return e || (s.y = o.pageYOffset || a.scrollTop, s.x = o.pageXOffset || a.scrollLeft), n[1] = n[1] + s.y - (a.clientTop || 0), n[0] = n[0] + s.x - (a.clientLeft || 0), n
    }
    ...
    function s(t, e, n, r, s) {
        if (!n && !r) throw new Error("mousePosition requires either element or offset be provided");
        return n && !r && (r = o(n, !1, i)), r = r, (s = s || [-1, -1])[0] = t - r[0], s[1] = e - r[1], s
    }

    e.mousePosition = s, e.mousePositionFromEvent = function (t, n, o, i) {
        let a, c;
        if (e.isTouchEvent(t) ? t.touches && t.touches[0] ? (a = t.touches[0].clientX, c = t.touches[0].clientY) : (a = NaN, c = NaN) : (a = t.clientX, c = t.clientY), !n && r(t.target) && (n = t.target), !n) throw new Error("mousePositionFromEvent requires an element parameter");
        return s(a, c, n, o, i)
    }
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    const r = n(34);
    e.clamp = (t, e = 0, n = 1) => Math.min(n, Math.max(e, t)), e.degrees = t => 180 * t / Math.PI, e.radians = t => t * Math.PI / 180, e.flipCoin = (t = .5) => Math.random() > t, e.lerp = (t, e, n) => n * (e - t) + t, e.interpolateArray = (t, e, n, o, i = []) => r.fastMap(e, (e, r) => {
        return t(e, n[r], (i = o, Array.isArray(i) || (t => !!t.length && "number" == typeof t.BYTES_PER_ELEMENT && "number" == typeof t.byteLength)(i) ? o[r] : o));
        var i
    }, i), e.lerpArray = (t, n, r, o = []) => e.interpolateArray(e.lerp, t, n, r, o), e.normalizedRandom = () => 2 * Math.random() - 1, e.randomRange = (t = 0, e = 1) => Math.random() * (e - t) + t, e.range = t => [Math.min(...t), Math.max(...t)], e.scalemap = function (t, e, n, r, o) {
        return r + (t - e) / (n - e) * (o - r)
    }, e.toPrecision = (t, e = .001) => Math.floor(t / e) * e, e.weightedRandom = (t, n) => {
        n || (n = t.reduce((t, e) => t + e[0], 0));
        const r = Math.floor(e.randomRange(0, n));
        let o = null, i = n;
        for (const e of t) if (i -= e[0], i <= r) {
            o = e[1];
            break
        }
        return o
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    const i = n(14), s = n(3), a = n(32), c = n(65);
    e.defaultSampleProcessor = (t, e, n, r) => o(void 0, void 0, void 0, (function* () {
        if (!a.isCanvasImageSource(e)) throw new Error("Default Processor requires `sample` to be HTMLCanvasElement");
        const o = a.cropTo(e, t.sampleSize);
        return {sample: o, displaySample: n || o, uid: r || c.generate()}
    }));

    class l extends s.LitElement {
        constructor() {
            super(...arguments), this.stats = !1, this.label = null, this.buttonLabel = "", this.buttonSVG = "", this.open = !1, this.disabled = !1, this.sampleSize = 224, this.runSample = !1, this.skipDisplaySample = !1, this.maxSamples = 1 / 0, this.samplesArePlayable = !1, this.processData = {}, this.mapAsyncSample = e.defaultSampleProcessor, this._samples = [], this._sampleUIDs = [], this._tapAsyncPreview = null, this._displaySamples = []
        }
        ...
        addSample(t) {
            for (i.util.assert(null != t.sample, () => "received an empty or invalid sample"), i.util.assert(null != t.displaySample, () => "received an invalid displaySample"), this._samples.push(t.sample), this._displaySamples.push(t.displaySample), this._sampleUIDs.push(t.uid); this._samples.length > this.maxSamples;) this._samples.shift();
            for (; this._displaySamples.length > this.maxSamples;) this._displaySamples.shift();
            for (; this._sampleUIDs.length > this.maxSamples;) this._sampleUIDs.shift();
        ...
        clearSamples() {
            this._samples = [], this._displaySamples = [], this._sampleUIDs = [], this.dispatchEvent(new CustomEvent("clear", {bubbles: !0, composed: !0}))
        }

        _dispatchRecordStart() {
            this.dispatchEvent(new CustomEvent("recordstart", {bubbles: !0, composed: !1}))
        }

        _dispatchRecordStop() {
            this.dispatchEvent(new CustomEvent("recordstop", {bubbles: !0, composed: !1}))
        }

        __dispatchSample() {
            this._statsElement && this._statsElement.now(), this.dispatchEvent(new CustomEvent("sample", {bubbles: !0, composed: !1}))
        }

        updated(t) {
            return t.has("stats") && (this.stats ? (this._statsElement = this._statsElement || document.createElement("tm-stats"), this._statsElement.now(), this._statsElement.now(), this.shadowRoot.appendChild(this._statsElement), this._statsElement.mapStats = t => `${t.fps} fps, ${this.samples.length} / ${this.maxSamples} samples`) : this._statsElement && (this._statsElement.parentNode && this._statsElement.parentNode.removeChild(this._statsElement), this._statsElement = null)), super.updated(t)
        }
    }

    r([s.property({type: Boolean, reflect: !0})], l.prototype, "stats", void 0), r([s.property({type: String})], l.prototype, "label", void 0), r([s.property({type: String})], l.prototype, "buttonLabel", void 0), r([s.property({type: String})], l.prototype, "buttonSVG", void 0), r([s.property({type: Boolean, reflect: !0})], l.prototype, "open", void 0), r([s.property({type: Boolean, reflect: !0})], l.prototype, "disabled", void 0), r([s.property({type: Number})], l.prototype, "sampleSize", void 0), r([s.property({type: Boolean})], l.prototype, "runSample", void 0), r([s.property({type: Boolean})], l.prototype, "skipDisplaySample", void 0), r([s.property({type: Number})], l.prototype, "maxSamples", void 0), r([s.property({type: Boolean})], l.prototype, "samplesArePlayable", void 0), e.AbstractSampleInputElement = l
}, function (t, e, n) {
    var r, o = n(66), i = n(68), s = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ";
    ...
    t.exports = function () {
        function t(t) {
            var e = t || s, n = o(o.HEX, e), r = o(e, o.HEX), c = function () {
                return a(i(), n)
            };
            return {
                new: c, generate: c, uuid: i, fromUUID: function (t) {
                    return a(t, n)
                }, toUUID: function (t) {
                    return function (t, e) {
                        for (var n, r = e(t), o = "", i = 0, s = 32 - r.length; i < s; ++i) o += "0";
                        return [(n = (o + r).match(/(\w{8})(\w{4})(\w{4})(\w{4})(\w{12})/))[1], n[2], n[3], n[4], n[5]].join("-")
                    }(t, r)
                }, alphabet: e
            }
        }

        return t.constants = {flickrBase58: s, cookieBase90: "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!#$%&'()*+-./:<=>?@[]^_`{|}~"}, t.uuid = i, t.generate = function () {
    ...
    o.BIN = "01", o.OCT = "01234567", o.DEC = "0123456789", o.HEX = "0123456789abcdef", t.exports = o
}, function (t, e, n) {
    "use strict";
    ...
    r.prototype.convert = function (t) {
        var e, n, r, o = {}, i = this.srcAlphabet.length, s = this.dstAlphabet.length, a = t.length, c = "string" == typeof t ? "" : [];
        ...
        do {
            for (n = 0, r = 0, e = 0; e < a; e++) (n = n * i + o[e]) >= s ? (o[r++] = parseInt(n / s, 10), n %= s) : r > 0 && (o[r++] = 0);
    ...
    class c extends i.LitElement {
        constructor() {
            super(...arguments), this.value = "", this.kind = "any", this.hideWhenEmpty = !1, this.devices = [], this.parseLabel = a
        }

        refreshDevices() {
            return o(this, void 0, void 0, (function* () {
                const t = (yield s.enumerateDevices()).filter(t => t.kind === this.kind);
                return t.length > 1 && "audioinput" === this.kind && t[0].groupId === t[1].groupId && t.shift(), t
            }))
        }

        firstUpdated(t) {
            this.refreshDevices().then(t => {
                this.devices = t, this.requestUpdate()
            }).catch(t => console.error("error", t)), super.firstUpdated(t)
        }
        ...
        render() {
            ...
            <div class='select-container'>
                <select
                    ...
                    @change=${t => {
                const e = t.target;
                this.value = e.value, t.stopPropagation(), this.dispatchEvent(new CustomEvent("change", {bubbles: !0}))
            }}
    ...
    r([i.property({type: String})], c.prototype, "value", void 0), r([i.property({type: String})], c.prototype, "kind", void 0), r([i.property({type: Boolean})], c.prototype, "hideWhenEmpty", void 0), e.MediaDeviceSelectElement = c, customElements.define("tm-media-device-select", c)
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    const r = new class {
        constructor() {
            this.__storageKey = "tm2Settings", null === this.__getSettings() && this.__saveSettings({})
        }
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var a = n(14), c = n(14), l = n(39), u = n(38), h = n(74);

    function p(t, e) {
        for (var n, r = t.length, o = t.slice(), i = r - 1; i > 0; i -= 1) {
            var s = void 0;
            n = [o[s = e ? Math.floor(e() * (i + 1)) : Math.floor(Math.random() * (i + 1))], o[i]], o[i] = n[0], o[s] = n[1]
        }
        return o
    }
        ...
        return o(e, t), Object.defineProperty(e.prototype, "asSequentialModel", {
            ...
            return i(this, void 0, void 0, (function () {
                ...
                return s(this, (function (i) {
                    var s;
                    return n = "object" == typeof (s = e).dataId && "object" === s.shape ? e : l.capture(e), r = this.truncatedModel.predict(n), o = r.dataSync(), n.dispose(), r.dispose(), this.examples[t].push(o), this.totalSamples++, [2]
                }))
            }))
            ...
            for (var t in this.examples) if (0 === t.length) throw new Error("Add some examples before training");
            ...
            for (var t = 0; t < this.examples.length; t++) this.examples[t] = p(this.examples[t], this.seed);
            var e = [], n = [], r = function (t) {
                var r, i, s, a = (r = t, i = o.numClasses, (s = new Array(i).fill(0))[r] = 1, s), c = o.examples[t].length, l = c - Math.ceil(.15 * c), u = o.examples[t].slice(0, l).map((function (t) {
                    return {data: t, label: a}
            ...
            var i = a.data.array(e.map((function (t) {
                return t.data
            }))), s = a.data.array(n.map((function (t) {
                return t.data
            }))), c = a.data.array(e.map((function (t) {
                return t.label
            }))), l = a.data.array(n.map((function (t) {
                return t.label
            })));
            return {trainDataset: a.data.zip({xs: i, ys: c}), validationDataset: a.data.zip({xs: s, ys: l})}
            ...
            return void 0 === e && (e = {}), i(this, void 0, void 0, (function () {
                var n, r, o, i, l, u, h, p, d, f = this;
                return s(this, (function (s) {
                    switch (s.label) {
                        case 0:
                            if (n = e.onTrainEnd || function () {
                            }, e.onTrainEnd = function (t) {
                                f.__stopTrainingResolve && (f.__stopTrainingResolve(), f.__stopTrainingResolve = null), n(t)
                            }, this.isPrepared || this.prepare(), r = this.getLabels().length, c.util.assert(r === this.numClasses, (function () {
                                return "Can not train, has " + r + " labels and " + f.numClasses + " classes"
                            })), o = this.truncatedModel.outputs[0].shape.slice(1), i = a.util.sizeFromShape(o), l = this.seed ? a.initializers.varianceScaling({seed: 3.14}) : a.initializers.varianceScaling({}), this.trainingModel = a.sequential({layers: [a.layers.dense({inputShape: [i], units: t.denseUnits, activation: "relu", kernelInitializer: l, useBias: !0}), a.layers.dense({kernelInitializer: l, useBias: !1, activation: "softmax", units: this.numClasses})]}), u = a.train.adam(t.learningRate), this.trainingModel.compile({optimizer: u, loss: "categoricalCrossentropy", metrics: ["accuracy"]}), !(t.batchSize > 0)) throw new Error("Batch size is 0 or NaN. Please choose a non-zero fraction");
                            return h = this.trainDataset.batch(t.batchSize), p = this.validationDataset.batch(t.batchSize), [4, this.trainingModel.fitDataset(h, {epochs: t.epochs, validationData: p, callbacks: e})];
                        case 1:
                            return s.sent(), (d = a.sequential()).add(this.truncatedModel), d.add(this.trainingModel), this.model = d, u.dispose(), [2, this.model]
                    }
                }))
            }))
            ...
            return i(this, void 0, void 0, (function () {
                var t, e, n, r, o, c, l, u, h, p, d, f, y, m, g, v, b, w, _ = this;
                return s(this, (function (x) {
                    switch (x.label) {
                        case 0:
                            ...
                            })), n = Math.min(e.size, 32), r = Math.ceil(e.size / n), o = t.batch(n), c = e.batch(n), [4, o.iterator()];
                        case 1:
                        ...
                        case 4:
                            return d = x.sent(), f = this.trainingModel.predict(d.value), y = f.argMax(1), h.push(y), [4, u.next()];
                        case 5:
                            m = x.sent(), g = m.value.argMax(1), p.push(g), d.value.dispose(), f.dispose(), m.value.dispose(), x.label = 6;
                        case 6:
                            return w++, [3, 3];
                        case 7:
                            if (v = a.concat(p), b = a.concat(h), 1 !== r) for (w = 0; w < h.length; w++) h[w].dispose(), p[w].dispose();
                            return [2, {reference: v, predictions: b}]
                    }
                }))
            }))
    ...
    e.TeachableMobileNet = d, e.createTeachable = function (t, e) {
        return i(this, void 0, void 0, (function () {
            var n;
            return s(this, (function (r) {
                switch (r.label) {
    ...
    var r = n(75), o = n(76), i = n(77), s = n(78), a = n(79), c = n(80), l = n(81);
    l.alea = r, l.xor128 = o, l.xorwow = i, l.xorshift7 = s, l.xor4096 = a, l.tychei = c, t.exports = l
}, function (t, e, n) {
    (function (t) {
        var r;
        !function (t, o, i) {
            ...
            function c(t, e) {
                var n = new s(t), r = e && e.state, o = n.next;
            ...
            o && o.exports ? o.exports = c : n(7) && n(18) ? void 0 === (r = function () {
                return c
            }.call(e, n, e, o)) || (o.exports = r) : this.alea = c
        }(0, t, n(7))
    }).call(this, n(17)(t))
}, function (t, e, n) {
    (function (t) {
        ...
        !function (t, o, i) {
            ...
            function c(t, e) {
                var n = new s(t), r = e && e.state, o = function () {
            ...
            o && o.exports ? o.exports = c : n(7) && n(18) ? void 0 === (r = function () {
                return c
            }.call(e, n, e, o)) || (o.exports = r) : this.xor128 = c
        }(0, t, n(7))
    }).call(this, n(17)(t))
}, function (t, e, n) {
    (function (t) {
        ...
        !function (t, o, i) {
            ...
            o && o.exports ? o.exports = c : n(7) && n(18) ? void 0 === (r = function () {
                return c
            }.call(e, n, e, o)) || (o.exports = r) : this.xorwow = c
        }(0, t, n(7))
    }).call(this, n(17)(t))
}, function (t, e, n) {
    (function (t) {
        ...
        !function (t, o, i) {
            ...
            o && o.exports ? o.exports = c : n(7) && n(18) ? void 0 === (r = function () {
                return c
            }.call(e, n, e, o)) || (o.exports = r) : this.xorshift7 = c
        }(0, t, n(7))
    }).call(this, n(17)(t))
}, function (t, e, n) {
    (function (t) {
        ...
        !function (t, o, i) {
            function s(t) {
                var e = this;
                e.next = function () {
                    var t, n, r = e.w, o = e.X, i = e.i;
                    return e.w = r = r + 1640531527 | 0, n = o[i + 34 & 127], t = o[i = i + 1 & 127], n ^= n << 13, t ^= t << 17, n ^= n >>> 15, t ^= t >>> 12, n = o[i] = n ^ t, e.i = i, n + (r ^ r >>> 16) | 0
                }, function (t, e) {
                    var n, r, o, i, s, a = [], c = 128;
                    for (e === (0 | e) ? (r = e, e = null) : (e += "\0", r = 0, c = Math.max(c, e.length)), o = 0, i = -32; i < c; ++i) e && (r ^= e.charCodeAt((i + 32) % e.length)), 0 === i && (s = r), r ^= r << 10, r ^= r >>> 15, r ^= r << 4, r ^= r >>> 13, i >= 0 && (s = s + 1640531527 | 0, o = 0 == (n = a[127 & i] ^= r + s) ? o + 1 : 0);
            ...
            o && o.exports ? o.exports = c : n(7) && n(18) ? void 0 === (r = function () {
                return c
            }.call(e, n, e, o)) || (o.exports = r) : this.xor4096 = c
        }(0, t, n(7))
    }).call(this, n(17)(t))
}, function (t, e, n) {
    (function (t) {
        ...
        !function (t, o, i) {
            ...
            o && o.exports ? o.exports = c : n(7) && n(18) ? void 0 === (r = function () {
                return c
            }.call(e, n, e, o)) || (o.exports = r) : this.tychei = c
        }(0, t, n(7))
    }).call(this, n(17)(t))
}, function (t, e, n) {
    var r;
    !function (o, i) {
        var s, a = (0, eval)("this"), c = i.pow(256, 6), l = i.pow(2, 52), u = 2 * l;

        function h(t, e, n) {
            var r = [], h = f(function t(e, n) {
                var r, o = [], i = typeof e;
            ...
            }((e = 1 == e ? {entropy: !0} : e || {}).entropy ? [t, y(o)] : null == t ? function () {
                try {
                    var t;
                    return s && (t = s.randomBytes) ? t = t(256) : (t = new Uint8Array(256), (a.crypto || a.msCrypto).getRandomValues(t)), y(t)
                } catch (t) {
                    var e = a.navigator, n = e && e.plugins;
                    return [+new Date, a, n, a.screen, y(o)]
                }
            }() : t, 3), r), m = new p(r), g = function () {
                for (var t = m.g(6), e = c, n = 0; t < l;) t = 256 * (t + n), e *= 256, n = m.g(1);
                for (; t >= u;) t /= 2, e /= 2, n >>>= 1;
                return (t + n) / e
            };
            ...
            }, g.double = g, f(y(m.S), o), (e.pass || n || function (t, e, n, r) {
                return r && (r.S && d(r, m), t.state = function () {
                    return d(m, {})
                }), n ? (i.random = t, e) : t
        ...
        function p(t) {
            ...
            for (o = 0; o < 256; o++) s[o] = s[i = 255 & i + t[o % n] + (e = s[o])], s[i] = e;
            (r.g = function (t) {
                for (var e, n = 0, o = r.i, i = r.j, s = r.S; t--;) e = s[o = 255 & o + 1], n = 256 * n + s[255 & (s[o] = s[i = 255 & i + e]) + (s[i] = e)];
        ...
        function f(t, e) {
            for (var n, r = t + "", o = 0; o < r.length;) e[255 & o] = 255 & (n ^= 19 * e[255 & o]) + r.charCodeAt(o++);
            return y(e)
        }
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var s = n(8), a = n(40), c = {facingMode: "user", frameRate: 24}, l = function () {
        function t(t, e, n) {
        ...
        return t.prototype.getWebcam = function (t) {
            ...
            t.width = 640;
            var e = function (t) {
                return t.facingMode = t.facingMode || c.facingMode, t.frameRate = t.frameRate || c.frameRate, t.aspectRatio = t.aspectRatio || c.aspectRatio, t
            }(t), n = document.createElement("video");
            return window.navigator.mediaDevices.getUserMedia({video: e}).then((function (t) {
                return n.srcObject = t, n.addEventListener("loadedmetadata", (function (t) {
                    var e = n.videoWidth, r = n.videoHeight;
        ...
        }, r([s.default], t.prototype, "getWebcam", null), r([s.default], t.prototype, "setup", null), r([s.default], t.prototype, "play", null), r([s.default], t.prototype, "pause", null), r([s.default], t.prototype, "stop", null), r([s.default], t.prototype, "update", null), r([s.default], t.prototype, "stopStreamedVideo", null), r([s.default], t.prototype, "renderCameraToCanvas", null), t
    }();
    e.Webcam = l
}, function (t, e, n) {
    "use strict";
    ...
    t.exports = function () {
        ...
        for (var n, a, c = s(t), l = 1; l < arguments.length; l++) {
            ...
            if (r) {
                a = r(n);
                for (var h = 0; h < a.length; h++) i.call(n, a[h]) && (c[a[h]] = n[a[h]])
            }
        }
        return c
    }
    ...
    (function (t) {
        ...
        e.format = function (t) {
            ...
            n = 1;
            for (var r = arguments, i = r.length, s = String(t).replace(o, (function (t) {
                if ("%%" === t) return "%";
                if (n >= i) return t;
                switch (t) {
                    case"%s":
            ...
            })), c = r[n]; n < i; c = r[++n]) y(c) || !w(c) ? s += " " + c : s += " " + a(c);
            return s
        ...
        function a(t, n) {
            ...
            return arguments.length >= 3 && (r.depth = arguments[2]), arguments.length >= 4 && (r.colors = arguments[3]), f(n) ? r.showHidden = n : n && e._extend(r, n), v(r.showHidden) && (r.showHidden = !1), v(r.depth) && (r.depth = 2), v(r.colors) && (r.colors = !1), v(r.customInspect) && (r.customInspect = !0), r.colors && (r.stylize = c), u(r, t, r.depth)
        }
        ...
        function u(t, n, r) {
            ...
            var l, w = "", E = !1, T = ["{", "}"];
            (d(n) && (E = !0, T = ["[", "]"]), S(n)) && (w = " [Function" + (n.name ? ": " + n.name : "") + "]");
            return b(n) && (w = " " + RegExp.prototype.toString.call(n)), _(n) && (w = " " + Date.prototype.toUTCString.call(n)), x(n) && (w = " " + h(n)), 0 !== s.length || E && 0 != n.length ? r < 0 ? b(n) ? t.stylize(RegExp.prototype.toString.call(n), "regexp") : t.stylize("[Object]", "special") : (t.seen.push(n), l = E ? function (t, e, n, r, o) {
                for (var i = [], s = 0, a = e.length; s < a; ++s) A(e, String(s)) ? i.push(p(t, e, n, r, String(s), !0)) : i.push("");
        ...
        function p(t, e, n, r, o, i) {
            var s, a, c;
            if ((c = Object.getOwnPropertyDescriptor(e, o) || {value: e[o]}).get ? a = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (a = t.stylize("[Setter]", "special")), A(r, o) || (s = "[" + o + "]"), a || (t.seen.indexOf(c.value) < 0 ? (a = y(n) ? u(t, c.value, null) : u(t, c.value, n - 1)).indexOf("\n") > -1 && (a = i ? a.split("\n").map((function (t) {
                return "  " + t
            })).join("\n").substr(2) : "\n" + a.split("\n").map((function (t) {
                return "   " + t
            })).join("\n")) : a = t.stylize("[Circular]", "special")), v(s)) {
                if (i && o.match(/^\d+$/)) return a;
                (s = JSON.stringify("" + o)).match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/) ? (s = s.substr(1, s.length - 2), s = t.stylize(s, "name")) : (s = s.replace(/'/g, "\\'").replace(/\\"/g, '"').replace(/(^"|"$)/g, "'"), s = t.stylize(s, "string"))
            }
            return s + ": " + a
        }
        ...
        e.debuglog = function (n) {
            if (v(i) && (i = t.env.NODE_DEBUG || ""), n = n.toUpperCase(), !s[n]) if (new RegExp("\\b" + n + "\\b", "i").test(i)) {
                var r = t.pid;
                s[n] = function () {
            ...
            return s[n]
        }, e.inspect = a, a.colors = {bold: [1, 22], italic: [3, 23], underline: [4, 24], inverse: [7, 27], white: [37, 39], grey: [90, 39], black: [30, 39], blue: [34, 39], cyan: [36, 39], green: [32, 39], magenta: [35, 39], red: [31, 39], yellow: [33, 39]}, a.styles = {special: "cyan", number: "yellow", boolean: "yellow", undefined: "grey", null: "bold", string: "green", date: "magenta", regexp: "red"}, e.isArray = d, e.isBoolean = f, e.isNull = y, e.isNullOrUndefined = function (t) {
            return null == t
        }, e.isNumber = m, e.isString = g, e.isSymbol = function (t) {
            return "symbol" == typeof t
        }, e.isUndefined = v, e.isRegExp = b, e.isObject = w, e.isDate = _, e.isError = x, e.isFunction = S, e.isPrimitive = function (t) {
        ...
        }, e.inherits = n(87), e._extend = function (t, e) {
            if (!e || !w(e)) return t;
        ...
        e.promisify = function (t) {
            ...
            return Object.setPrototypeOf(e, Object.getPrototypeOf(t)), P && Object.defineProperty(e, P, {value: e, enumerable: !1, writable: !1, configurable: !0}), Object.defineProperties(e, r(t))
    ...
    e.reduceTemplate = (t, e) => {
        return (n = e) && "function" == typeof n ? e(t) : "string" == typeof e ? r.html`${e}` : e;
        var n
    }
}, function (t, e, n) {
    "use strict";
    (function (t) {
        var r = n(90), o = n(91), i = n(92);
        ...
        function l(t, e, n, r) {
            ...
            return "undefined" != typeof ArrayBuffer && e instanceof ArrayBuffer ? function (t, e, n, r) {
                ...
                var r = 0 | f(e, n), o = (t = a(t, r)).write(e, n);
                o !== r && (t = t.slice(0, o));
                return t
            }(t, e, n) : function (t, e) {
                if (c.isBuffer(e)) {
        ...
        function h(t, e) {
            if (u(e), t = a(t, e < 0 ? 0 : 0 | d(e)), !c.TYPED_ARRAY_SUPPORT) for (var n = 0; n < e; ++n) t[n] = 0;
            return t
        }
        ...
        function v(t, e, n, r, o) {
            ...
            if (o) {
                var u = -1;
                for (i = n; i < a; i++) if (l(t, i) === l(e, -1 === u ? 0 : i - u)) {
                    if (-1 === u && (u = i), i - u + 1 === c) return u * s
                } else -1 !== u && (i -= i - u), u = -1
            } else for (n + c > a && (n = a - c), i = n; i >= 0; i--) {
                for (var h = !0, p = 0; p < c; p++) if (l(t, i + p) !== l(e, p)) {
                    h = !1;
                    break
                }
                if (h) return i
        ...
        function k(t, e, n) {
            ...
            for (var r = [], o = e; o < n;) {
                var i, s, a, c, l = t[o], u = null, h = l > 239 ? 4 : l > 223 ? 3 : l > 191 ? 2 : 1;
                if (o + h <= n) switch (h) {
                    case 1:
                        l < 128 && (u = l);
                        break;
                ...
                null === u ? (u = 65533, h = 1) : u > 65535 && (u -= 65536, r.push(u >>> 10 & 1023 | 55296), u = 56320 | 1023 & u), r.push(u), o += h
            }
            return function (t) {
                var e = t.length;
        ...
        e.Buffer = c, e.SlowBuffer = function (t) {
            ...
            return l(null, t, e, n)
        }, c.TYPED_ARRAY_SUPPORT && (c.prototype.__proto__ = Uint8Array.prototype, c.__proto__ = Uint8Array, "undefined" != typeof Symbol && Symbol.species && c[Symbol.species] === c && Object.defineProperty(c, Symbol.species, {value: null, configurable: !0})), c.alloc = function (t, e, n) {
            return function (t, e, n, r) {
            ...
            if (e >= n) return 1;
            if (this === t) return 0;
            for (var i = (o >>>= 0) - (r >>>= 0), s = (n >>>= 0) - (e >>>= 0), a = Math.min(i, s), l = this.slice(r, o), u = t.slice(e, n), h = 0; h < a; ++h) if (l[h] !== u[h]) {
                i = l[h], s = u[h];
                break
            }
        ...
        c.prototype.slice = function (t, e) {
            ...
            return t = +t, e |= 0, n || D(this, t, e, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : O(this, t, e, !0), e + 2
        }, c.prototype.writeUInt16BE = function (t, e, n) {
            return t = +t, e |= 0, n || D(this, t, e, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : O(this, t, e, !1), e + 2
        }, c.prototype.writeUInt32LE = function (t, e, n) {
            return t = +t, e |= 0, n || D(this, t, e, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : M(this, t, e, !0), e + 4
        }, c.prototype.writeUInt32BE = function (t, e, n) {
            return t = +t, e |= 0, n || D(this, t, e, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : M(this, t, e, !1), e + 4
            ...
            return t = +t, e |= 0, n || D(this, t, e, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : O(this, t, e, !0), e + 2
        }, c.prototype.writeInt16BE = function (t, e, n) {
            return t = +t, e |= 0, n || D(this, t, e, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : O(this, t, e, !1), e + 2
        }, c.prototype.writeInt32LE = function (t, e, n) {
            return t = +t, e |= 0, n || D(this, t, e, 4, 2147483647, -2147483648), c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : M(this, t, e, !0), e + 4
        }, c.prototype.writeInt32BE = function (t, e, n) {
            return t = +t, e |= 0, n || D(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), c.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : M(this, t, e, !1), e + 4
            ...
            if (e >>>= 0, n = void 0 === n ? this.length : n >>> 0, t || (t = 0), "number" == typeof t) for (i = e; i < n; ++i) this[i] = t; else {
                var s = c.isBuffer(t) ? t : U(new c(t, r).toString()), a = s.length;
    ...
    e.byteLength = function (t) {
        ...
        var e, n, r = l(t), s = r[0], a = r[1], c = new i(function (t, e, n) {
            return 3 * (e + n) / 4 - n
        }(0, s, a)), u = 0, h = a > 0 ? s - 4 : s;
        for (n = 0; n < h; n += 4) e = o[t.charCodeAt(n)] << 18 | o[t.charCodeAt(n + 1)] << 12 | o[t.charCodeAt(n + 2)] << 6 | o[t.charCodeAt(n + 3)], c[u++] = e >> 16 & 255, c[u++] = e >> 8 & 255, c[u++] = 255 & e;
        ...
        for (var e, n = t.length, o = n % 3, i = [], s = 0, a = n - o; s < a; s += 16383) i.push(u(t, s, s + 16383 > a ? a : s + 16383));
    ...
    e.read = function (t, e, n, r, o) {
        var i, s, a = 8 * o - r - 1, c = (1 << a) - 1, l = c >> 1, u = -7, h = n ? o - 1 : 0, p = n ? -1 : 1, d = t[e + h];
        for (h += p, i = d & (1 << -u) - 1, d >>= -u, u += a; u > 0; i = 256 * i + t[e + h], h += p, u -= 8) ;
        for (s = i & (1 << -u) - 1, i >>= -u, u += r; u > 0; s = 256 * s + t[e + h], h += p, u -= 8) ;
        if (0 === i) i = 1 - l; else {
        ...
        var s, a, c, l = 8 * i - o - 1, u = (1 << l) - 1, h = u >> 1, p = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = r ? 0 : i - 1, f = r ? 1 : -1, y = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (a = isNaN(e) ? 1 : 0, s = u) : (s = Math.floor(Math.log(e) / Math.LN2), e * (c = Math.pow(2, -s)) < 1 && (s--, c *= 2), (e += s + h >= 1 ? p / c : p * Math.pow(2, 1 - h)) * c >= 2 && (s++, c /= 2), s + h >= u ? (a = 0, s = u) : s + h >= 1 ? (a = (e * c - 1) * Math.pow(2, o), s += h) : (a = e * Math.pow(2, h - 1) * Math.pow(2, o), s = 0)); o >= 8; t[n + d] = 255 & a, d += f, a /= 256, o -= 8) ;
        for (s = s << o | a, l += o; l > 0; t[n + d] = 255 & s, d += f, s /= 256, l -= 8) ;
        t[n + d - f] |= 128 * y
    }
}, function (t, e) {
    var n = {}.toString;
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    var r = n(23), o = n(9), i = n(45), s = n(2), a = n(100), c = n(46);

    function l(t, e, n, i) {
        if (null == i && (i = s.inferDtype(t)), "complex64" === i) throw new Error("Cannot construct a complex64 tensor directly. Please use tf.complex(real, imag).");
        if (!s.isTypedArray(t) && !Array.isArray(t) && "number" != typeof t && "boolean" != typeof t && "string" != typeof t) throw new Error("values passed to tensor(values) must be a number/boolean/string or an array of numbers/booleans/strings, or a TypedArray");
        if (null != e) {
            s.assertNonNegativeIntegerDimensions(e);
            var a = s.sizeFromShape(e), c = s.sizeFromShape(n);
            s.assert(a === c, (function () {
                return "Based on the provided shape, [" + e + "], the tensor should have " + a + " values but has " + c
            }));
            for (var l = 0; l < n.length; ++l) {
                var u = n[l], h = l !== n.length - 1 || u !== s.sizeFromShape(e.slice(l));
                s.assert(n[l] === e[l] || !h, (function () {
                    return "Error creating a new Tensor. Inferred shape (" + n + ") does not match the provided shape (" + e + "). "
                }))
            }
        }
        return s.isTypedArray(t) || Array.isArray(t) || (t = [t]), e = e || n, t = "string" !== i ? s.toTypedArray(t, i, o.env().getBool("DEBUG")) : s.flatten(t, [], !0), r.ENGINE.makeTensor(t, e, i)
    }
    ...
    function h(t, e) {
        if (void 0 === e && (e = "float32"), "complex64" === e) {
            var n = h(t, "float32"), o = h(t, "float32");
    ...
    e.tensor = function (t, e, n) {
        ...
        if ((s.isTypedArray(t) && "string" !== e || Array.isArray(t)) && "complex64" !== e) throw new Error("Error creating a new Scalar: value must be a primitive (number|boolean|string)");
        if ("string" === e && s.isTypedArray(t) && !(t instanceof Uint8Array)) throw new Error("When making a scalar from encoded string, the value must be `Uint8Array`.");
        return l(t, [], [], e)
    }, e.tensor1d = u, e.tensor2d = function (t, e, n) {
        if (s.assertNonNull(t), null != e && 2 !== e.length) throw new Error("tensor2d() requires shape to have two numbers");
        ...
        if (s.assertNonNull(t), null != e && 3 !== e.length) throw new Error("tensor3d() requires shape to have three numbers");
        var r = i.inferShape(t, n);
        ...
        if (s.assertNonNull(t), null != e && 4 !== e.length) throw new Error("tensor4d() requires shape to have four numbers");
        var r = i.inferShape(t, n);
        ...
        if (s.assertNonNull(t), null != e && 5 !== e.length) throw new Error("tensor5d() requires shape to have five numbers");
        var r = i.inferShape(t, n);
        ...
        if (s.assertNonNull(t), null != e && 6 !== e.length) throw new Error("tensor6d() requires shape to have six numbers");
        var r = i.inferShape(t, n);
        ...
        var o = Math.abs(Math.ceil((e - t) / n)), i = s.makeZerosTypedArray(o, r);
        e < t && 1 === n && (n = -1), i[0] = t;
        ...
        onesLike_: function (t) {
            ...
            if ("complex64" === n.dtype) {
                var o = e.onesLike(a.real(n)), s = e.zerosLike(a.imag(n));
                return a.complex(o, s)
            }
            return r.ENGINE.runKernelFunc((function (t) {
                return t.onesLike(n)
            }), {$x: n}, (function (t, n) {
                return {
                    $x: function () {
    ...
    e.getKernel = function (t, e) {
        ...
        for (var e = r.entries(), n = []; ;) {
            var o = e.next(), i = o.done, s = o.value;
            if (i) break;
            var a = s[0], c = s[1];
        ...
        var e = t.kernelName, n = t.backendName, i = o(e, n);
        if (r.has(i)) throw new Error("The kernel '" + e + "' for backend '" + n + "' is already registered");
        r.set(i, t)
    }, e.unregisterKernel = function (t, e) {
        var n = o(t, e);
        if (!r.has(n)) throw new Error("The kernel '" + t + "' for backend '" + e + "' is not registered");
        r.delete(n)
    }
}, function (t, e, n) {
    "use strict";
    ...
    var r = n(2), o = function () {
        function t(t, e) {
            this.backendTimer = t, this.logger = e, null == e && (this.logger = new s)
        }

        return t.prototype.profileKernel = function (t, e, n) {
            var r, o = this, s = this.backendTimer.time((function () {
                r = n()
            }));
            return r.forEach((function (n) {
                n.data().then((function (r) {
                    i(r, n.dtype, t), s.then((function (i) {
                        var s = "";
                        null != i.getExtraProfileInfo && (s = i.getExtraProfileInfo()), o.logger.logKernelProfile(t, n, r, i.kernelMs, e, s)
                    }))
                }))
            })), r
        }, t
    ...
    var s = function () {
        ...
        return t.prototype.logKernelProfile = function (t, e, n, o, i, s) {
            var a = r.rightPad(o + "ms", 9), c = r.rightPad(t, 25), l = e.rank, u = e.size, h = r.rightPad(e.shape.toString(), 14), p = "";
            for (var d in i) {
                var f = i[d].shape, y = f.length;
                p += d + ": " + y + "D " + (y > 0 ? f : "") + " "
            }
            console.log("%c" + c + "\t%c" + a + "\t%c" + l + "D " + h + "\t%c" + u + "\t%c" + p + "\t%c" + s, "font-weight:bold", "color:red", "color:blue", "color: orange", "color: green", "color: steelblue")
        }, t
    }();
    e.Logger = s
}, function (t, e, n) {
    ...
    e.getFilteredNodesXToY = function (t, e, n) {
        ...
        for (i = 0; i < t.length; i++) {
            var s = (f = t[i]).inputs;
            for (var a in s) {
                for (var c = s[a], l = !1, u = 0; u < e.length; u++) if (r[c.id]) {
        ...
        h[n.id] = !0;
        var p = {};
        for (i = t.length - 1; i >= 0; i--) for (s = (f = t[i]).inputs, u = 0; u < f.outputs.length; u++) if (h[f.outputs[u].id]) {
        ...
        for (var o = function (o) {
            ...
            var a = i.gradient(s), c = function (e) {
                if (!(e in a)) throw new Error("Cannot backprop through input " + e + ". Available gradients found: " + Object.keys(a) + ".");
                var o = n((function () {
                    return a[e]()
                }));
                if ("float32" !== o.dtype) throw new Error("Error in gradient for op " + i.name + ". The gradient of input " + e + " must have 'float32' dtype, but has '" + o.dtype + "'");
                var s = i.inputs[e];
                if (!r.arraysEqual(o.shape, s.shape)) throw new Error("Error in gradient for op " + i.name + ". The gradient of input '" + e + "' has shape '" + o.shape + "', which does not match the shape of the input '" + s.shape + "'");
                if (null == t[s.id]) t[s.id] = o; else {
                    var c = t[s.id];
    ...
    function o(t, e, n) {
        var o;
        return o = Array.isArray(t) ? parseFloat(t[0].toFixed(7)) + " + " + parseFloat(t[1].toFixed(7)) + "j" : r.isString(t) ? "'" + t + "'" : "bool" === n ? i(t) : parseFloat(t.toFixed(7)).toString(), r.rightPad(o, e)
    }
    ...
    e.tensorToString = function (t, e, n, a) {
        var c = r.computeStrides(e), l = function (t, e, n, i) {
            var a = r.sizeFromShape(e), c = i[i.length - 1], l = new Array(c).fill(0), u = e.length, h = "complex64" === n ? s(t) : t;
            if (u > 1) for (var p = 0; p < a / c; p++) for (var d = p * c, f = 0; f < c; f++) l[f] = Math.max(l[f], o(h[d + f], 0, n).length);
            return l
        }(t, e, n, c), u = e.length, h = function t(e, n, r, a, c, l) {
            void 0 === l && (l = !0);
            var u = "complex64" === r ? 2 : 1, h = n[0], p = n.length;
            if (0 === p) {
                return "complex64" === r ? [o(s(e)[0], 0, r)] : "bool" === r ? [i(e[0])] : [e[0].toString()]
            }
            if (1 === p) {
                if (h > 20) {
                    var d = 3 * u, f = Array.from(e.slice(0, d)), y = Array.from(e.slice(h - 3 * u, h));
                    return "complex64" === r && (f = s(f), y = s(y)), ["[" + f.map((function (t, e) {
                        return o(t, c[e], r)
                    })).join(", ") + ", ..., " + y.map((function (t, e) {
                        return o(t, c[h - 3 + e], r)
                    })).join(", ") + "]"]
                }
                return ["[" + ("complex64" === r ? s(e) : Array.from(e)).map((function (t, e) {
                    return o(t, c[e], r)
                })).join(", ") + "]"]
            }
            var m = n.slice(1), g = a.slice(1), v = a[0] * u, b = [];
            if (h > 20) {
                for (var w = 0; w < 3; w++) {
                    var _ = (x = w * v) + v;
            ...
            var E = ",\n";
            for (w = 2; w < p; w++) E += "\n";
            return b[b.length - 1] = " " + b[b.length - 1] + "]" + (l ? "" : E), b
        }(t, e, n, c, l), p = ["Tensor"];
        return a && (p.push("  dtype: " + n), p.push("  rank: " + u), p.push("  shape: [" + e + "]"), p.push("  values:")), p.push(h.map((function (t) {
            return "    " + t
        })).join("\n")), p.join("\n")
    }
}, function (t, e, n) {
    ...
    var a = {float32: i, int32: r, bool: o, complex64: s};
    ...
    e.upcastType = c, e.sumOutType = function (t) {
        return c(t, "int32")
    }
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    var r = n(23), o = n(45), i = n(2), s = n(46);
    e.complex = s.op({
        complex_: function (t, e) {
            var n = o.convertToTensor(t, "real", "complex"), s = o.convertToTensor(e, "imag", "complex");
            return i.assertShapesMatch(n.shape, s.shape, "real and imag shapes, " + n.shape + " and " + s.shape + ", must match in call to tf.complex()."), r.ENGINE.runKernelFunc((function (t) {
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), n(103), n(104);
    var r = n(105);
    e.browserFiles = r.browserFiles;
    var o = n(44);
    e.browserHTTPRequest = o.browserHTTPRequest, e.http = o.http, e.isHTTPScheme = o.isHTTPScheme;
    var i = n(19);
    e.concatenateArrayBuffers = i.concatenateArrayBuffers, e.decodeWeights = i.decodeWeights, e.encodeWeights = i.encodeWeights, e.getModelArtifactsInfoForJSON = i.getModelArtifactsInfoForJSON;
    var s = n(106);
    e.fromMemory = s.fromMemory, e.withSaveHandler = s.withSaveHandler;
    var a = n(20);
    e.getLoadHandlers = a.getLoadHandlers, e.getSaveHandlers = a.getSaveHandlers, e.registerLoadRouter = a.registerLoadRouter, e.registerSaveRouter = a.registerSaveRouter;
    var c = n(48);
    e.loadWeights = c.loadWeights, e.weightsLoaderFactory = c.weightsLoaderFactory;
    var l = n(31);
    e.copyModel = l.copyModel, e.listModels = l.listModels, e.moveModel = l.moveModel, e.removeModel = l.removeModel
}, function (t, e, n) {
    "use strict";
    var r = this && this.__awaiter || function (t, e, n, r) {
        return new (n || (n = Promise))((function (o, i) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(9), s = n(19), a = n(31), c = n(20);

    function l() {
        if (!i.env().getBool("IS_BROWSER")) throw new Error("Failed to obtain IndexedDB factory because the current environmentis not a web browser.");
    ...
    function u(t) {
        var e = t.result;
        e.createObjectStore("models_store", {keyPath: "modelPath"}), e.createObjectStore("model_info_store", {keyPath: "modelPath"})
    }
    ...
    e.deleteDatabase = function () {
        return r(this, void 0, void 0, (function () {
            ...
            return o(this, (function (e) {
                return t = l(), [2, new Promise((function (e, n) {
        ...
        return t.prototype.save = function (t) {
            ...
            return new Promise((function (t, r) {
                ...
                o.onupgradeneeded = function () {
                    ...
                    var i = o.result;
                    if (null == e) {
                        var a = i.transaction("models_store", "readonly"), c = a.objectStore("models_store").get(n.modelPath);
                        c.onsuccess = function () {
                            if (null == c.result) return i.close(), r(new Error("Cannot find model with path '" + n.modelPath + "' in IndexedDB."));
                        ...
                        var l, u = s.getModelArtifactsInfoForJSON(e), h = i.transaction("model_info_store", "readwrite"), p = h.objectStore("model_info_store"), d = p.put({modelPath: n.modelPath, modelArtifactsInfo: u});
                        d.onsuccess = function () {
                            var o = (l = i.transaction("models_store", "readwrite")).objectStore("models_store").put({modelPath: n.modelPath, modelArtifacts: e, modelArtifactsInfo: u});
                            o.onsuccess = function () {
                                return t({modelArtifactsInfo: u})
                            }, o.onerror = function (t) {
                                var e = (p = h.objectStore("model_info_store")).delete(n.modelPath);
                            ...
                            null == l ? i.close() : l.oncomplete = function () {
                                return i.close()
                            }
                        }
                    }
    ...
    e.BrowserIndexedDB = h, e.indexedDBRouter = function (t) {
        return i.env().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(h.URL_SCHEME) ? p(t.slice(h.URL_SCHEME.length)) : null
    }, c.IORouterRegistry.registerSaveRouter(e.indexedDBRouter), c.IORouterRegistry.registerLoadRouter(e.indexedDBRouter), e.browserIndexedDB = p;
    var d = function () {
        function t() {
            this.indexedDB = l()
        }
        ...
        return t.prototype.listModels = function () {
                ...
                return o(this, (function (e) {
                    return [2, new Promise((function (e, n) {
                        ...
                        r.onupgradeneeded = function () {
                            ...
                            var t = r.result, o = t.transaction("model_info_store", "readonly"), i = o.objectStore("model_info_store").getAll();
            ...
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (n) {
                    var r;
                    return t = (r = t).startsWith(h.URL_SCHEME) ? r.slice(h.URL_SCHEME.length) : r, [2, new Promise((function (n, r) {
                        var o = e.indexedDB.open("tensorflowjs", 1);
                        o.onupgradeneeded = function () {
                            return u(o)
                        }, o.onsuccess = function () {
                            var e, i = o.result, s = i.transaction("model_info_store", "readwrite"), a = s.objectStore("model_info_store"), c = a.get(t);
                            c.onsuccess = function () {
                                if (null == c.result) return i.close(), r(new Error("Cannot find model with path '" + t + "' in IndexedDB."));
                                var o = a.delete(t), s = function () {
                                    var o = (e = i.transaction("models_store", "readwrite")).objectStore("models_store").delete(t);
                                    o.onsuccess = function () {
                                ...
                                o.onsuccess = s, o.onerror = function (t) {
    ...
    if (e.BrowserIndexedDBManager = d, i.env().getBool("IS_BROWSER")) try {
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(9), s = n(2), a = n(19), c = n(31), l = n(20), u = "tensorflowjs_models", h = "info", p = "model_topology", d = "weight_specs", f = "weight_data", y = "model_metadata";

    function m(t) {
        return {info: [u, t, h].join("/"), topology: [u, t, p].join("/"), weightSpecs: [u, t, d].join("/"), weightData: [u, t, f].join("/"), modelMetadata: [u, t, y].join("/")}
    }
    ...
    e.purgeLocalStorageArtifacts = function () {
        if (!i.env().getBool("IS_BROWSER") || void 0 === window.localStorage) throw new Error("purgeLocalStorageModels() cannot proceed because local storage is unavailable in the current environment.");
    ...
    var v = function () {
        function t(t) {
            if (!i.env().getBool("IS_BROWSER") || void 0 === window.localStorage) throw new Error("The current environment does not support local storage.");
        ...
        return t.prototype.save = function (t) {
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (o) {
                    if (t.modelTopology instanceof ArrayBuffer) throw new Error("BrowserLocalStorage.save() does not support saving model topology in binary formats yet.");
                    e = JSON.stringify(t.modelTopology), n = JSON.stringify(t.weightSpecs), r = a.getModelArtifactsInfoForJSON(t);
                    try {
                        return this.LS.setItem(this.keys.info, JSON.stringify(r)), this.LS.setItem(this.keys.topology, e), this.LS.setItem(this.keys.weightSpecs, n), this.LS.setItem(this.keys.weightData, a.arrayBufferToBase64String(t.weightData)), this.LS.setItem(this.keys.modelMetadata, JSON.stringify({format: t.format, generatedBy: t.generatedBy, convertedBy: t.convertedBy})), [2, {modelArtifactsInfo: r}]
                    } catch (t) {
            ...
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (o) {
                    ...
                    if (e.weightSpecs = r, null != (i = this.LS.getItem(this.keys.modelMetadata)) && (s = JSON.parse(i), e.format = s.format, e.generatedBy = s.generatedBy, e.convertedBy = s.convertedBy), null == (c = this.LS.getItem(this.keys.weightData))) throw new Error("In local storage, the binary weight values of model '" + this.modelPath + "' are missing.");
    ...
    e.BrowserLocalStorage = v, e.localStorageRouter = function (t) {
        return i.env().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(v.URL_SCHEME) ? b(t.slice(v.URL_SCHEME.length)) : null
    }, l.IORouterRegistry.registerSaveRouter(e.localStorageRouter), l.IORouterRegistry.registerLoadRouter(e.localStorageRouter), e.browserLocalStorage = b;
    var w = function () {
        function t() {
        ...
        return t.prototype.listModels = function () {
            return r(this, void 0, void 0, (function () {
                var t, e, n, r, i, s;
                return o(this, (function (o) {
                    for (t = {}, e = u + "/", n = "/" + h, r = 0; r < this.LS.length; ++r) (i = this.LS.key(r)).startsWith(e) && i.endsWith(n) && (s = g(i), t[s] = JSON.parse(this.LS.getItem(i)));
                    return [2, t]
                }))
            }))
        }, t.prototype.removeModel = function (t) {
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (r) {
                    var o;
                    if (t = (o = t).startsWith(v.URL_SCHEME) ? o.slice(v.URL_SCHEME.length) : o, e = m(t), null == this.LS.getItem(e.info)) throw new Error("Cannot find model at path '" + t + "'");
    ...
    if (e.BrowserLocalStorageManager = w, i.env().getBool("IS_BROWSER")) try {
    ...
    var l = function () {
        function t(e) {
            if (!i.env().getBool("IS_BROWSER")) throw new Error("browserDownloads() cannot proceed because the current environment is not a browser.");
            e.startsWith(t.URL_SCHEME) && (e = e.slice(t.URL_SCHEME.length)), null != e && 0 !== e.length || (e = "model"), this.modelTopologyFileName = e + ".json", this.weightDataFileName = e + ".weights.bin"
        }
            ...
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (o) {
                    switch (o.label) {
                        ...
                        case 1:
                            return n = [{paths: ["./" + this.weightDataFileName], weights: t.weightSpecs}], r = {modelTopology: t.modelTopology, format: t.format, generatedBy: t.generatedBy, convertedBy: t.convertedBy, weightsManifest: n}, i = window.URL.createObjectURL(new Blob([JSON.stringify(r)], {type: "application/json"})), (a = null == this.jsonAnchor ? document.createElement("a") : this.jsonAnchor).download = this.modelTopologyFileName, a.href = i, [4, c((function () {
                                return a.dispatchEvent(new MouseEvent("click"))
                            }))];
                        case 2:
                            return o.sent(), null == t.weightData ? [3, 4] : ((l = null == this.weightDataAnchor ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName, l.href = e, [4, c((function () {
                                return l.dispatchEvent(new MouseEvent("click"))
                            }))]);
                        case 3:
                            o.sent(), o.label = 4;
                        case 4:
                            return [2, {modelArtifactsInfo: s.getModelArtifactsInfoForJSON(t)}]
                    }
                }))
            }))
            ...
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (r) {
                    return t = this.files[0], e = this.files.slice(1), [2, new Promise((function (r, o) {
                        ...
                        i.onload = function (i) {
                            var a = JSON.parse(i.target.result), c = a.modelTopology;
                            if (null != c) {
                                0 === e.length && r({modelTopology: c});
                                ...
                                if (null != l) {
                                    ...
                                    l.forEach((function (t) {
                                        ...
                                        t.paths.forEach((function (t) {
                                            ...
                                            e.onload = function (e) {
                                                var n = e.target.result, o = p.indexOf(t);
                                                d[o] = n, -1 === d.indexOf(null) && r({modelTopology: c, weightSpecs: h, weightData: s.concatenateArrayBuffers(d)})
    ...
    e.browserDownloadsRouter = function (t) {
        return i.env().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(l.URL_SCHEME) ? h(t.slice(l.URL_SCHEME.length)) : null
    }, a.IORouterRegistry.registerSaveRouter(e.browserDownloadsRouter), e.browserDownloads = h, e.browserFiles = function (t) {
        return new u(t)
    }
}, function (t, e, n) {
    "use strict";
    ...
    e.fromMemory = function (t, e, n, r) {
        if (1 === arguments.length) {
            ...
            return o ? new i(t) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new i({modelTopology: t}))
        }
        return console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new i({modelTopology: t, weightSpecs: e, weightData: n, trainingConfig: r})
    }, e.withSaveHandler = function (t) {
        return new s(t)
    }
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.config = {PUBLISH_URL: "https://us-central1-gweb-teachable-ai.cloudfunctions.net/publish-release-2-1-2/publish"}
}, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    const r = () => JSON.parse(window.localStorage.getItem("__teachable-machine-api__"));
    e.addPublished = t => {
        const e = r();
        e.published = e.published || [], e.published.push(t), (t => {
    ...
    r([o.property({type: String})], i.prototype, "label", void 0), i = r([o.customElement("teachable-button")], i), e.TeachableButtonElement = i
}, function (t, e, n) {
    "use strict";
    var r = this && this.__awaiter || function (t, e, n, r) {
        return new (n || (n = Promise))((function (o, i) {
    ...
    e.WebcamImageApp = class {
        constructor() {
            this.teachable = null, this.labels = [], this._isRecordingSample = !1, this._hasTrained = !1
        }

        load() {
            return r(this, void 0, void 0, (function* () {
                this.teachable = yield o.createTeachable({}, {alpha: .35, version: 2}), this.teachable.setLabels(this.labels), this.teachable.warm()
            }))
        }

        bindToWebcamForClass(t, e, n, r = {}) {
            let o = null;
            o = "string" == typeof t ? document.querySelector(t) : t, -1 === this.labels.indexOf(n) && (this.labels.push(n), this.teachable.setLabels(this.labels), this._hasTrained = !1);
            const i = t => {
                this.addExample(n, e.lastDisplaySample), r.onSample && r.onSample(e.lastDisplaySample)
            }, s = t => {
                t.preventDefault(), this._isRecordingSample = !0, document.addEventListener("mouseup", a), document.addEventListener("touchend", a), e.addEventListener("sample", i), e.beginCapture()
            }, a = () => {
                console.log("on STP MF"), this._isRecordingSample = !1, e.removeEventListener("sample", i), e.endCapture(), document.removeEventListener("mouseup", a), document.removeEventListener("touchend", a)
            };
            return o.addEventListener("mousedown", s), o.addEventListener("touchstart", s), o
        }

        bindWebcamForPrediction(t, e) {
            t.addEventListener("sample", () => r(this, void 0, void 0, (function* () {
                this._hasTrained && !this._isRecordingSample && e(yield this.predict(t.lastDisplaySample))
            })))
        }

        bindWebcamForPredictionTopK(t, e) {
            t.addEventListener("sample", () => r(this, void 0, void 0, (function* () {
                this._hasTrained && !this._isRecordingSample && e(yield this.predictTopK(t.lastDisplaySample))
            })))
        }

        createTrainButton(t = {}) {
            const e = new i.ProgressButtonElement;
            e.classList.add("tm-train-button"), e.label = t.label || "Train", e.style.display = "inline-block", e.style.width = "210px", e.style.height = "50px", e.style.textTransform = "uppercase", e.style.setProperty("--background-color", "#646487"), e.style.setProperty("--fill-color", "#313152"), e.style.setProperty("--color", "#ffffff");
            const n = t.onEpochEnd, o = t.trainParameters && t.trainParameters.epochs ? t.trainParameters.epochs : 50, s = {
                onTrainBegin: t.onTrainBegin, onTrainEnd: t.onTrainEnd, onEpochBegin: t.onEpochBegin, onEpochEnd: (t, i) => r(this, void 0, void 0, (function* () {
                    e.value = t / o, n && (yield n(t, i))
                })), onBatchBegin: t.onBatchBegin, onBatchEnd: t.onBatchEnd, onYield: t.onYield
            };
            return e.addEventListener("click", () => r(this, void 0, void 0, (function* () {
                yield this.train(t.trainParameters, s), t.onTrainComplete && t.onTrainComplete()
            }))), e
        }

        createWebcam(t = {}, e) {
            const n = new i.WebcamSampleInput;
            return n.classList.add("tm-webcam"), n.open = !0, n.autoPlay = !0, n.showRecord = !0, e && n.addEventListener("sample", () => r(this, void 0, void 0, (function* () {
        ...
        addExample(t, e) {
            if (!this.teachable) throw new Error("Attempted to add an example but model is not loaded, be sure to call load() first");
        ...
        train(t = {}, e = {}) {
            return r(this, void 0, void 0, (function* () {
                if (t.denseUnits = t.denseUnits || 100, t.epochs = t.epochs || 50, t.learningRate = t.learningRate || 1e-4, t.batchSize = t.batchSize || 16, !this.teachable) throw new Error("Attempted to add an example but model is not loaded, be sure to call load() first");
